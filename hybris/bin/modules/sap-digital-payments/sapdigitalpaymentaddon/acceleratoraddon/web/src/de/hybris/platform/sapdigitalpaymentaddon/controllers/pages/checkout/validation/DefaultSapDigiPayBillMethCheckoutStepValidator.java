...
/**
 *
 * Payment and Billing method validator class for the multi-step checkout flow with SAP Digital payment
 *
 */
public class DefaultSapDigiPayBillMethCheckoutStepValidator extends AbstractCheckoutStepValidator
{

	private static final Logger LOGGER = Logger.getLogger(DefaultSapDigiPayBillMethCheckoutStepValidator.class);
