...
/**
 * Checkout summary validator class for the multi-step checkout flow with SAP Digital payment
 *
 *
 */
public class DefaultSapDigiPaySummaryCheckoutStepValidator extends AbstractCheckoutStepValidator
{

	private static final Logger LOGGER = Logger.getLogger(DefaultSapDigiPaySummaryCheckoutStepValidator.class);
