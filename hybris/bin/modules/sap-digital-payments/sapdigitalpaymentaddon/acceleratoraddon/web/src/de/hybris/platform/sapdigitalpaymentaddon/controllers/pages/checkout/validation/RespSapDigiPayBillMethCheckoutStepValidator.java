...
/**
 *
 * Responsive payment and Billing method validator class for the multstep checkout flow with SAP Digital payment
 *
 */
public class RespSapDigiPayBillMethCheckoutStepValidator extends AbstractCheckoutStepValidator
{

	private static final Logger LOGGER = Logger.getLogger(RespSapDigiPayBillMethCheckoutStepValidator.class);
