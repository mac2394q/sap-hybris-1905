...
public class DefaultGigyaUserPopulator implements Populator<CustomerModel, GSObject> {
	 ...
	 */
	private void handleAttribute(final GSObject gsObject, final GigyaFieldMappingModel mapping,
		...
		if (GyAttributeType.DATE.equals(mapping.getHybrisType())) {
			...
			gsObject.put(gigyaAttributeName,
					modelService.getAttributeValue(gigyaUser, mapping.getHybrisAttributeName()).toString());
		}
	}
