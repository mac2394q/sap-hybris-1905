...
public class DefaultGigyaUserReversePopulator implements Populator<GSResponse, CustomerModel> {
	 ...
	 * @param mapping
	 */
	private void handleAttributeMapping(final CustomerModel gigyaUser, final GSObject data,
	...
	private void handleAttribute(final GigyaFieldMappingModel mapping, final CustomerModel gigyaUser,
