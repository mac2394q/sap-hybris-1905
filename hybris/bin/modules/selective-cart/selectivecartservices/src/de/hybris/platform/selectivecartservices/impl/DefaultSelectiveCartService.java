...
public class DefaultSelectiveCartService implements SelectiveCartService
{
	...
	@Override
	public Optional<CartModel> getSelectiveCartForUser(final UserModel user)
	{
		return getSelectiveCartDao().findSelectiveCartByUser(user);
	}

	@Override
	public Optional<CartModel> getSelectiveCartForCode(final String code)
	{
		return getSelectiveCartDao().findSelectiveCartByCode(code);
	}
