...
public class UserSearchRestrictionsTest extends AbstractIntegrationTest
{
	...
	public void testIndexingWithUserRestriction() throws Exception
	{
		...
		// when
		final EnumerationValueModel approved = typeService.getEnumerationValue(
				enumerationService.getEnumerationValue(ArticleApprovalStatus._TYPECODE, ArticleApprovalStatus.APPROVED.getCode()));
