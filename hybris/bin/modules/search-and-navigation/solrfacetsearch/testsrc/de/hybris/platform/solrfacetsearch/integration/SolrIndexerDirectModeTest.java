...
@IntegrationTest
public class SolrIndexerDirectModeTest extends AbstractIntegrationTest
{
	@Rule
	...
	{
		importConfig("/test/integration/SolrIndexerDirectModeTest.csv");
	}
	...
	public void fullIndexAndUpdate() throws Exception
	{
		...
		// when
		indexerService.performFullIndex(facetSearchConfig);
		importConfig("/test/integration/SolrIndexerDirectModeTest_addProduct1.csv");
	...
	public void fullIndexTwiceAndUpdate() throws Exception
	{
		...
		indexerService.updateIndex(facetSearchConfig);
		indexerService.performFullIndex(facetSearchConfig);
		importConfig("/test/integration/SolrIndexerDirectModeTest_addProduct2.csv");
		indexerService.updateIndex(facetSearchConfig);
	...
	public void activeIndexDoesNotChangeAfterFullIndexTwice() throws Exception
	{
		...
		assertEquals(index1.getQualifier(), index2.getQualifier());
	}
	...
	public void activeIndexDoesNotChangeAfterFullIndexThreeTimes() throws Exception
	{
		...
		assertEquals(index1.getQualifier(), index2.getQualifier());
		assertEquals(index2.getQualifier(), index3.getQualifier());
	}
}
