...
public class DefaultSolrServerConfigPopulatorIntegrationTest extends ServicelayerBaseTest
{
	...
	private static final String PROPERTIES_AUTO_ADD_REPLICAS = "true";
	...
	private static final String DB_AUTO_ADD_REPLICAS = "false";
	...
	public void shouldReturnAutoAddReplicasFromPropertiesWhenThereAreNoModeInDBAndPropertyIsSet()
	{
		...
		setAutoAddReplicasPropertyFor(solrConfig);
		final Boolean autoAddReplicas = defaultSolrServerConfigPopulator.populateAutoAddReplicas(solrConfig);

		assertNotNull(autoAddReplicas);
		assertThat(autoAddReplicas).isEqualTo(Boolean.valueOf(PROPERTIES_AUTO_ADD_REPLICAS));
	...
	public void shouldReturnAutoAddReplicasFromDBWhenThereIsModeInDBAndPropertyIsNotSet()
	{
		...
		assertNotNull(autoAddReplicas);
		assertThat(autoAddReplicas).isEqualTo(Boolean.valueOf(DB_AUTO_ADD_REPLICAS));
	}
	...
	private void setAutoAddReplicasPropertyFor(final SolrServerConfigModel config)
	{
		Config.setParameter("solr.config." + config.getName() + ".autoAddReplicas", PROPERTIES_AUTO_ADD_REPLICAS);
	}
