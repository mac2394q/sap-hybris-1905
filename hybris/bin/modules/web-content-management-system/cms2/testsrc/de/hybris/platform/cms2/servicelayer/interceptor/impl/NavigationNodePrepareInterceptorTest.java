...
public class NavigationNodePrepareInterceptorTest extends ServicelayerTransactionalTest
{
	...
	protected CMSNavigationNodeModel prepareNavigationNode(final String name, final CMSNavigationNodeModel parent)
	{
	...
	protected CMSNavigationNodeModel prepareHiddenRootNavigationNode(final CatalogVersionModel catalogVersion)
	{
