...
public class ItemSynchronizationControllerWebServiceTest extends ApiBaseIntegrationTest
{
	...
	public void setup()
	{
		...
		contentSlotForPageModelMother.FooterHomepage_ParagraphOnly(stagedCatalogVersionModel);
	}
	...
	{
		contentPageModelMother.approveHomePage(stagedCatalogVersionModel);
		catalogVersionModelMother.performCatalogSyncronization(stagedCatalogVersionModel, onlineCatalogVersionModel);
	...
	@Test
	public void givenPageOutOfSync_WhenItemSynchronizationIsCalled_ThenItMustFail() throws Exception
	{
		// GIVEN
		catalogVersionModelMother.performCatalogSyncronization(stagedCatalogVersionModel, onlineCatalogVersionModel);
