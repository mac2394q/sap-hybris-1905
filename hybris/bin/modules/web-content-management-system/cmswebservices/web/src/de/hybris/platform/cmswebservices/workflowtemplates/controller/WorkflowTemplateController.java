...
public class WorkflowTemplateController
{
	...
	@ResponseBody
	@ApiOperation(value = "Get Workflow templates for catalog version", notes = "Endpoint to retrieve the list of available workflow templates for given catalogId and versionId.")
	@ApiImplicitParams(
	{ //
