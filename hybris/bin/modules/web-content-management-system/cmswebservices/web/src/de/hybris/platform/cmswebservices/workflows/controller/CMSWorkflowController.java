...
public class CMSWorkflowController
{
	...
	@ResponseBody
	@ApiOperation( //
			value = "Create and start a new workflow", notes = "Endpoint that creates a workflow containing CmsItems and starts it")
	@ApiImplicitParams(
	{ //
	...
	public CMSWorkflowWsDTO createWorkflow(
			...
			@RequestBody //
			final CMSWorkflowWsDTO workflowDto)
	{
		try
		{
			final CMSWorkflowData requestData = getDataMapper().map(workflowDto, CMSWorkflowData.class);
	...
	@ResponseBody
	@ApiOperation( //
			value = "Updates an existing workflow", notes = "Endpoint that updates a workflow")
	@ApiImplicitParams(
	{ //
			@ApiImplicitParam(name = "catalogId", value = "The id of the catalog", required = true, dataType = "string", paramType = "path"),
			@ApiImplicitParam(name = "versionId", value = "The version of the catalog", required = true, dataType = "string", paramType = "path") })
	...
	@ResponseBody
	@ApiOperation( //
			value = "Find all workflows containing the given attachments", notes = "Endpoint that finds all workflow "
	...
	@ResponseBody
	@ApiOperation( //
			value = "Retrieves a workflow item", notes = "Endpoint that retrieves a workflow item")
	@ApiImplicitParams(
	{ //
			@ApiImplicitParam(name = "catalogId", value = "The id of the catalog", required = true, dataType = "string", paramType = "path"),
			@ApiImplicitParam(name = "versionId", value = "The version of the catalog", required = true, dataType = "string", paramType = "path") })
