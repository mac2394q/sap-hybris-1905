...
public class CMSWorkflowOperationsController
{
	...
	@ResponseBody
	@ApiOperation(value = "Perform different operations on the workflow item.", notes = "Endpoint to perform different operations on the workflow item such as cancel a workflow etc.")
	@ApiImplicitParams(
	{ //
