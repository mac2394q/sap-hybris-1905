...
public class CMSWorkflowActionController
{
	...
	@ResponseBody
	@ApiOperation( //
			value = "Retrieves workflow action comments", notes = "Endpoint that retrieves workflow action comments")
	@ApiImplicitParams(
	{ //
	...
	@ResponseBody
	@ApiOperation( //
			value = "Retrieves the list of actions for a given workflow item", notes = "Endpoint that retrieves a list of actions for a given workflow item")
	@ApiImplicitParams(
	{ //
			@ApiImplicitParam(name = "catalogId", value = "The id of the catalog", required = true, dataType = "string", paramType = "path"),
			@ApiImplicitParam(name = "versionId", value = "The version of the catalog", required = true, dataType = "string", paramType = "path") })
