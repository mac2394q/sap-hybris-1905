...
public class DefaultComponentTypeStructureRegistry implements ComponentTypeStructureRegistry, InitializingBean
{
	...
	@Override
	public Optional<ComponentTypeAttributeStructure> getComponentTypeAttributeStructure(final String typecode,
	 ...
	 */
	@Deprecated
	@HybrisDeprecation(sinceVersion = "1905")
	@Override
