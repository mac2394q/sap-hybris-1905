...
public class DefaultCMSItemFacade implements CMSItemFacade
{
	...
	protected void setOriginalItemContext(final Map<String, Object> source)
	{
		...
		Optional.ofNullable((String) source.get(FIELD_UUID)) //
				.or(() -> Optional.ofNullable((String) source.get(FIELD_PAGE_UUID))) //
				.ifPresent((final String uuid) -> getUniqueItemIdentifierService().getItemModel(uuid, CMSItemModel.class)
