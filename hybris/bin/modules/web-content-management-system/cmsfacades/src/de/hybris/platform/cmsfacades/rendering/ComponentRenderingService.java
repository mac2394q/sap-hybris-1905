...
public interface ComponentRenderingService
{
	 ...
	 * categoryCode or productCode or catalogCode. The result of the method is retrieved from the cache if the {@link RenderingCacheService} is enabled.
	 * 
	 * @param componentIds
	 ...
	 * by categoryCode or productCode or catalogCode. The result of the method is retrieved from the cache if the {@link RenderingCacheService} is enabled.
	 * 
	 * @param categoryCode
	 *           the optional category code
	 * @param productCode
