...
public class DefaultPageRenderingService implements PageRenderingService
{
	...
	{
		return getRestrictionAwareService().execute(restrictionData,
				() -> getRenderingCacheService()
						.cacheOrElse(pageModel, () -> getPageModelToDataRenderingConverter().convert(pageModel)));
	}
	...
	public void setRenderingCacheService(
			final RenderingCacheService<AbstractPageData> renderingCacheService)
	{
