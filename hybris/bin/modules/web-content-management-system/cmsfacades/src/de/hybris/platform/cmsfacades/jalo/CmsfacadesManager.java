 ...
 */
public class CmsfacadesManager extends GeneratedCmsfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CmsfacadesManager.class);
	 ...
	 */
	public static CmsfacadesManager getInstance()
	{
		return (CmsfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CmsfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CmsfacadesManager() // NOPMD
	{
		LOG.debug("constructor of CmsfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CmsfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CmsfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
