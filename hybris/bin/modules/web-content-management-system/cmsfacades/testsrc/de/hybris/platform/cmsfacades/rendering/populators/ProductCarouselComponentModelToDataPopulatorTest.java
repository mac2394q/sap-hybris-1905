...
public class ProductCarouselComponentModelToDataPopulatorTest
{
	...
	public void setUp()
	{
		...
		when(productCarouselComponentCarouselPredicate.test(itemModel)).thenReturn(true);
	...
	{
		// GIVEN
		when(productCarouselComponentCarouselPredicate.test(itemModel)).thenReturn(false);
