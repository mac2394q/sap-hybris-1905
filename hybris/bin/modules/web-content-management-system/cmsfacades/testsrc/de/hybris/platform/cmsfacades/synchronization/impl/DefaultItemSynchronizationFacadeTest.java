...
public class DefaultItemSynchronizationFacadeTest
{
	...
	public void shouldValidateRequestAndSynchronizationDataBeforeSynchronizingItems()
	{
		...
		// THEN
		verify(facadeValidationService).validate(catalogSynchronizationCompositeValidator, syncRequestData);
		verify(facadeValidationService).validate(cmsItemSynchronizationValidator, synchronizationData);
	}
