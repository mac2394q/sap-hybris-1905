...
public class ContentSlotModelMother extends AbstractModelMother<ContentSlotModel>
{
	...
	public ContentSlotModel createHeaderSlotWithSharedParagraph(final CatalogVersionModel catalogVersion)
	{
		return getFromCollectionOrSaveAndReturn( //
				() -> getCmsContentSlotDao().findContentSlotsByIdAndCatalogVersions(UID_HEADER,
						Collections.singletonList(catalogVersion)), //
				() -> ContentSlotModelBuilder.fromModel(defaultSlot(catalogVersion)) //
						.withUid(UID_HEADER) //
						.withCmsComponents( //
								getParagraphComponentModelMother().createSharedParagraphComponentModel(catalogVersion)) //
						.build());
	}

	public ContentSlotModel createHeaderEmptySlot(final CatalogVersionModel catalogVersion)
	{
		return getFromCollectionOrSaveAndReturn( //
				() -> getCmsContentSlotDao().findContentSlotsByIdAndCatalogVersions(UID_HEADER,
						Collections.singletonList(catalogVersion)), //
	...
	public ContentSlotModel createFooterSlotWithParagraph(final CatalogVersionModel catalogVersion)
	{
		return getFromCollectionOrSaveAndReturn( //
				() -> getCmsContentSlotDao().findContentSlotsByIdAndCatalogVersions(UID_FOOTER,
						Collections.singletonList(catalogVersion)), //
				() -> ContentSlotModelBuilder.fromModel(defaultSlot(catalogVersion)) //
						.withUid(UID_FOOTER) //
						.withCmsComponents( //
								getParagraphComponentModelMother().createFooterParagraphComponentModel(catalogVersion)) //
						.build());
	}

	public ContentSlotModel createFooterSlotWithSharedParagraph(final CatalogVersionModel catalogVersion)
	{
		return getFromCollectionOrSaveAndReturn( //
				() -> getCmsContentSlotDao().findContentSlotsByIdAndCatalogVersions(UID_FOOTER,
						Collections.singletonList(catalogVersion)), //
