...
public class DefaultPageVariationResolverTest
{
	...
	public void shouldFindAllDefaultPages_ExistSingleUnrestrictedPage()
	{
		...
		when(adminRestrictionService.hasPageRestrictions(unrestrictedPage)).thenReturn(false);
	...
	public void shouldNotFindAllDefaultPages_NotExistSingleUnrestrictedPage()
	{
		...
		when(adminRestrictionService.hasPageRestrictions(restrictedPage)).thenReturn(true);
	...
	public void shouldFindAllVariationPages()
	{
		...
		when(adminPageService.findPagesByType(composedType, false)).thenReturn(Arrays.asList(variationPage1, variationPage2));
