...
public class IntegerAttributePredicateTest
{
	@Mock
	...
	public void setup()
	{
		predicate.setTypeClass(Integer.class);
	...
	{
		doReturn(Integer.class).when(attributeDescriptorModelHelperService).getAttributeClass(attributeDescriptor);
	...
	{
		doReturn(int.class).when(attributeDescriptorModelHelperService).getAttributeClass(attributeDescriptor);
		assertThat(predicate.test(attributeDescriptor), is(true));
	}
