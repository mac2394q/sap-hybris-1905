...
module.exports = function() {
    ...
    return {
        config: function(data, conf) {
            ...
            const cmsSmarteditInclude = smarteditCommonsInclude.concat(["../../jsTarget/web/features/cmssmartedit/**/*"]);
            const cmsSmarteditContainerInclude = smarteditCommonsInclude.concat(["../../jsTarget/web/features/cmssmarteditContainer/**/*"]);
            ...
            conf.generateKarmaSmarteditTsConfig.data.include = cmsSmarteditInclude.concat(["../../jsTests/tests/cmssmartedit/unit/**/*"]);
            conf.generateKarmaSmarteditContainerTsConfig.data.include = cmsSmarteditContainerInclude.concat(["../../jsTests/tests/cmssmarteditContainer/unit/**/*"]);
