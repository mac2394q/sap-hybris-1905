...
angular.module('restrictionsEditorModule', [
    ...
    .controller('restrictionsEditorController', function(
        ...
        this.showRemoveAllButton = function() {
            return this.restrictions.length > 0 && this.editable;
        }.bind(this);
        ...
        this.setupResults = function(results) {
            ...
            this.updateRestrictionsData();
            this._applyIsRestrictionEditable();
         ...
         */
        this._applyIsRestrictionEditable = function() {
            this.restrictions.forEach(function(restriction) {
                if (!lodash.isNil(restriction.uid)) {
                    contextAwareEditableItemService.isItemEditable(restriction.uid).then(function(isEditable) {
                        restriction.$$canBeEdited = isEditable;
                    }.bind(this));
                } else {
