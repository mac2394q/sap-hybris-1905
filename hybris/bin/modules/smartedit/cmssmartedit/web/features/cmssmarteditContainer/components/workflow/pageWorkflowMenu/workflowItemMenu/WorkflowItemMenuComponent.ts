...
export class WorkflowItemMenuComponent implements ISeComponent {
	...
	constructor(
		...
		this.systemEventService.subscribe('WORKFLOW_ITEM_MENU_OPENED_EVENT', this.onOtherMenuOpening.bind(this));

		this.getButtonsAfterApplyingPermissions(this.getButtonsConfiguration()).then((menuItems) => {
