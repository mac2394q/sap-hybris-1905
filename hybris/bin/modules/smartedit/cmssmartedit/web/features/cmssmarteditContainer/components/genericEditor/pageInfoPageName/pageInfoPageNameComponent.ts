 ...
 */
import {GenericEditorField, ICatalogService, IGenericEditor, ISeComponent, IUriContext, SeComponent, TypedMap} from 'smarteditcommons';
 ...
 */
@SeComponent({
	templateUrl: 'pageInfoPageNameTemplate.html',
	inputs: [
		'field',
		'qualifier',
		'model',
...
export class PageInfoPageNameComponent implements ISeComponent {
