...
angular.module('componentMenuModule', ['smarteditServicesModule', 'componentTypesTabModule', 'componentsTabModule', 'cmsDragAndDropServiceModule', 'componentMenuServiceModule'])
    .controller('componentMenuController', function($q, crossFrameEventService, componentMenuService, SMARTEDIT_DRAG_AND_DROP_EVENTS, EVENTS, DRAG_AND_DROP_CROSS_ORIGIN_BEFORE_TIME) {
        ...
        this.$onInit = function() {
            ...
            this.removePageChangeEventHandler = crossFrameEventService.subscribe(EVENTS.PAGE_CHANGE, this._initializeComponentMenu);
            this.removeOpenComponentEventHandler = crossFrameEventService.subscribe(OPEN_COMPONENT_EVENT, this._resetComponentMenu);
            this.removeDropdownEvent = crossFrameEventService.subscribe(SMARTEDIT_DRAG_AND_DROP_EVENTS.DRAG_DROP_START, function() {
                this.isDragging = true;
                this._closeMenu();
            }.bind(this));
            this.removeOverlapEvent = crossFrameEventService.subscribe(OVERLAY_DISABLED_EVENT, this._closeMenu);
            this.removeDragEndEvent = crossFrameEventService.subscribe(SMARTEDIT_DRAG_AND_DROP_EVENTS.DRAG_DROP_END, function() {
                this.isDragging = false;
