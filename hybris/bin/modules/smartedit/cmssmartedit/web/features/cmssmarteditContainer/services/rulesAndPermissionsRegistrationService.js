...
angular.module('rulesAndPermissionsRegistrationModule', [
    ...
    .run(function(
        ...
        var getCurrentPageActiveWorkflow = function() {
            if (!windowUtils.getTargetIFrame()) {
        ...
        function registerRules() {
            ...
            permissionService.registerRule({
                ...
                verify: function(permissionNameObjs) {
                    ...
                    var promises = permissionNameObjs.map(function(permissionNameObject) {
                        if (permissionNameObject.context) {
                            return workflowService.getActiveWorkflowForPageUuid(permissionNameObject.context.pageInfo.uuid).then(function(workflow) {
            ...
            permissionService.registerRule({
                ...
                verify: function(permissionNameObjs) {
                    function isUserParticipant(workflow) {
                        return workflow === null ? $q.when(true) : workflowService.isUserParticipanInActiveAction(workflow.workflowCode);
                    }
            ...
            permissionService.registerRule({
                ...
                verify: function() {
                    ...
                    return pageService.getCurrentPageInfo().then(function(pageInfo) {
                        return attributePermissionsRestService.hasChangePermissionOnAttributesInType(pageInfo.typeCode, [attributeName]);
        ...
        function registerRulesForTypeCode() {
            ...
            registerTypePermissionRuleForTypeCode('se.has.create.permission.on.abstractcomponent.type', 'AbstractCMSComponent', typePermissionsRestService.hasCreatePermissionForTypes.bind(typePermissionsRestService));
            registerTypePermissionRuleForTypeCode('se.has.change.permission.on.contentslotforpage.type', 'ContentSlotForPage', typePermissionsRestService.hasUpdatePermissionForTypes.bind(typePermissionsRestService));


            // check if current user has create/change permission on the Workflow type
            registerTypePermissionRuleForTypeCode('se.has.create.permission.on.workflow.type', 'Workflow', typePermissionsRestService.hasCreatePermissionForTypes.bind(typePermissionsRestService));
            registerTypePermissionRuleForTypeCode('se.has.change.permission.on.workflow.type', 'Workflow', typePermissionsRestService.hasUpdatePermissionForTypes.bind(typePermissionsRestService));
            registerTypePermissionRuleForTypeCode('se.has.read.permission.on.workflow.type', 'Workflow', typePermissionsRestService.hasReadPermissionForTypes.bind(typePermissionsRestService));

            registerTypePermissionRuleForTypeCode('se.has.create.permission.on.contentslot.type', 'ContentSlot', typePermissionsRestService.hasCreatePermissionForTypes.bind(typePermissionsRestService));
            registerTypePermissionRuleForTypeCode('se.has.delete.permission.on.contentslot.type', 'ContentSlot', typePermissionsRestService.hasDeletePermissionForTypes.bind(typePermissionsRestService));
        }

        function registerRulesForTypeAndQualifier() {
            var registerAttributePermissionRuleForTypeAndQualifier = function(ruleName, itemType, qualifier, verify) {
                permissionService.registerRule({
                    names: [ruleName],
                    verify: function() {
            ...
            registerAttributePermissionRuleForTypeAndQualifier('se.has.change.permission.on.workflow.status', 'Workflow', 'status', attributePermissionsRestService.hasChangePermissionOnAttributesInType.bind(attributePermissionsRestService));
            registerAttributePermissionRuleForTypeAndQualifier('se.has.change.permission.on.workflow.description', 'Workflow', 'description', attributePermissionsRestService.hasChangePermissionOnAttributesInType.bind(attributePermissionsRestService));
        }
        ...
        function registerPermissions() {
            ...
            permissionService.registerPermission({
                ...
                rules: ['se.sync.catalog', 'se.page.belongs.to.experience', 'se.current.user.can.act.on.page.in.workflow']
            });
            ...
            permissionService.registerPermission({
                ...
                rules: ['se.write.slot', 'se.page.belongs.to.experience', 'se.current.user.can.act.on.page.in.workflow']
            });
            ...
            permissionService.registerPermission({
                ...
                rules: ['se.write.component', 'se.page.belongs.to.experience', 'se.current.user.can.act.on.page.in.workflow']
            });
            ...
            permissionService.registerPermission({
                ...
                rules: ['se.write.page', 'se.page.belongs.to.experience', 'se.not.versioning.perspective', 'se.has.change.type.permissions.on.current.page', 'se.current.user.can.act.on.page.in.workflow']
            });

            permissionService.registerPermission({
                aliases: ['se.shared.slot.override.options'],
                rules: ['se.write.page', 'se.page.belongs.to.experience', 'se.not.versioning.perspective', 'se.current.user.can.act.on.page.in.workflow', 'se.has.create.permission.on.contentslot.type']
            });

            permissionService.registerPermission({
                aliases: ['se.revert.to.shared.slot.link'],
                rules: ['se.write.page', 'se.page.belongs.to.experience', 'se.not.versioning.perspective', 'se.current.user.can.act.on.page.in.workflow', 'se.has.delete.permission.on.contentslot.type']
            });
            ...
            permissionService.registerPermission({
                ...
                rules: ['se.write.to.current.catalog.version', 'se.has.change.permission.on.version.type', 'se.current.user.can.act.on.page.in.workflow']
            });
            ...
            permissionService.registerPermission({
                ...
                rules: ['se.has.create.permission.on.workflow.type', 'se.catalogversion.has.workflows.enabled', 'se.current.page.has.no.active.workflow']
            });

            permissionService.registerPermission({
                aliases: ['se.view.page.workflowMenu'],
                rules: ['se.has.read.permission.on.workflow.type', 'se.current.page.has.active.workflow']
            });
