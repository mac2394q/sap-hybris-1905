...
(function() {
    ...
    angular.module('addPageServiceModule', [
         ...
         */
        .controller('addPageWizardController', function($q, wizardManager, pageBuilderFactory, lodash, restrictionsStepHandlerFactory, experienceService, confirmationModalService, systemEventService, pageRestrictionsFacade, restrictionsService, GENERIC_EDITOR_UNRELATED_VALIDATION_MESSAGES_EVENT, EVENT_CONTENT_CATALOG_UPDATE, pageFacade) {
                ...
                return self.callbacks.savePageInfo().then(function(page) {
                    ...
                    return pageFacade.createPage(page).then(function(pageCreated) {
                        ...
                        if (pageCreated.typeCode === 'EmailPage') {
                            systemEventService.publishAsync(EVENT_CONTENT_CATALOG_UPDATE, pageCreated);
                            return pageCreated;
                        }
