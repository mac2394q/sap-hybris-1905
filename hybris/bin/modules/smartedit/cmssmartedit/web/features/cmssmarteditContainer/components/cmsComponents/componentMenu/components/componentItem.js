...
angular.module('componentItemModule', ['cmsSmarteditServicesModule', 'translationServiceModule'])
    .controller('componentItemController', function(assetsService, componentSharedService, $translate) {

        this.$onInit = function() {
            componentSharedService.isComponentShared(this.componentInfo).then(function(isSharedComponent) {
