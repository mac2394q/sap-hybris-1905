...
module.exports = function() {
    ...
    componentObject.elements = {
        ...
        getPageStatusLabel: function() {
            return this.getPageStatusComponent().element(by.css('.se-page-status-label')).getText();
        }
    };
    ...
    componentObject.assertions = {
        pageStatusComponentIsDisplayed: function(containingElement) {
            expect(componentObject.elements.getPageStatusComponent(containingElement)).toBeDisplayed();
        },
        ...
        pageStatusIsDisplayedCorrectly: function(expectedIcon, expectedLabel) {
            expect(componentObject.utils.hasClass(componentObject.elements.getPageStatusIcon(), expectedIcon)).toBeTruthy();
        ...
        pageIsInReadyToSyncStatus: function() {
            this.pageStatusIsDisplayedCorrectly('se-page-status-ready_to_sync__icon', 'Ready To Sync');
        },
        ...
        workflowIsUnavailableToCurrentUser: function() {
            ...
            expect(componentObject.utils.hasClass(componentObject.elements.getPageStatusIcon(), 'se-page-status-locked__icon')).toBeTruthy();
        }
    };
    ...
    componentObject.utils = {
        setMockPageDisplayStatus: function(status) {
            browser.executeScript('window.sessionStorage.setItem("customDisplayStatus", arguments[0])', status);
        },
