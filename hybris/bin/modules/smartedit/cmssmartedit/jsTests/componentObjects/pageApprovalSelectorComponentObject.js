...
if (typeof require !== 'undefined') {
    systemAlerts = require('./systemAlertsComponentObject');
}
...
module.exports = function() {
    ...
    componentObject.elements = {
        ...
        getPageApprovalDropdownList: function() {
            return this.getPageApprovalSelectorComponent().element(by.css('.se-page-approval--list'));
        },
        getPageApprovalStatusOption: function(optionTxt) {
            return this.getPageApprovalDropdownList().element(by.cssContainingText('.se-page-approval--item a', optionTxt));
        }
    };
    ...
    componentObject.actions = {
        ...
        clickOnOption: function(optionToChoose) {
            return browser.click(componentObject.elements.getPageApprovalStatusOption(optionToChoose));
        },
        forceDraftPageApprovalStatus: function() {
            this.openPageApprovalDropdown().then(function() {
    ...
    componentObject.assertions = {
        ...
        hasDraftOption: function() {
            expect(componentObject.elements.getPageApprovalStatusOption(componentObject.constants.DRAFT).isPresent()).toBeTruthy();
        },
        assertInfoAlertIsDisplayed: function() {
            var alertType = 'info';
            systemAlerts.assertions.assertTotalNumberOfAlerts(1);
            systemAlerts.assertions.assertAlertIsOfTypeByIndex(0, alertType);
        }
    };
