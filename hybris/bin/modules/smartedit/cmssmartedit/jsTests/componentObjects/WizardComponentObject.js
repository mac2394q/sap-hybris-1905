...
module.exports = (function() {
    ...
    var selectors = {
        nextButton: function() {
            return by.css('.se-modal__footer button#ACTION_NEXT');
        },
        backButton: function() {
            return by.css('.se-modal__footer button#ACTION_BACK');
        }
    };
    ...
    componentObject.elements = {
        ...
        submitButton: function() {
            return browser.findElement(by.css('.se-modal__footer button#ACTION_DONE'));
        },
        getCurrentStepText: function() {
            return browser.findElement(by.css('.se-modal-wizard-step__action--current')).getText().then(function(text) {
                return text.trim();
            });
        }
    };
