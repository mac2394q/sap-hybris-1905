    ...
    var componentObject = {
        ...
        select: function(perspectiveName) {
            return browser.waitUntilNoModal().then(function() {
                return browser.switchToParent().then(function() {
                    return browser.findElement(by.css('.se-perspective-selector__btn'), true).getText().then(function(perspectiveSelected) {
                        if (perspectiveSelected.toUpperCase() !== perspectiveName.toUpperCase()) {
                            browser.waitForWholeAppToBeReady();
                            browser.waitForVisibility('.se-perspective-selector');
                            return browser.click(browser.findElement(by.css('.se-perspective-selector')), true).then(function() {
                                return browser.click(browser.findElement(by.cssContainingText('.se-perspective__list-item', perspectiveName), true), "perspective " + perspectiveName + " is not clickable").then(function() {
        ...
        elements: {
            ...
            getPerspectiveModeByName: function(perspectiveName) {
                return element(by.cssContainingText('.se-perspective__list-item-text', perspectiveName));
            }
        },
