...
module.exports = (function() {
    ...
    restrictionsEditor.constants = {
        ...
        RESTRICTION_TABLE_ITEM: {
            HEADER: '.se-restriction__item-name',
            DESCRIPTION: '.se-restriction__item-description'
        },
    ...
    restrictionsEditor.elements = {
        ...
        getAddNewButton: function() {
            return element(by.css('.se-restrictions__add-restriction-btn'));
        },
        getRestrictionListSize: function() {
            return element.all(by.css('.se-restriction__item')).count();
        },
        getRestrictionInListByName: function(restrictionName) {
            var restrictionElements = element.all(by.css('.se-restriction__item'));
        ...
        getRestrictionMenuByName: function(restrictionName) {
            return restrictionsEditor.elements.getRestrictionInListByName(restrictionName).all(by.css('.dropdown-toggle')).first();
        },
        ...
        getApplyRuleDropdown: function() {
            return element(by.css('.se-restriction__select .ui-select-toggle'));
        },
        getAnyRestrictionOption: function() {
            return element(by.cssContainingText('.se-restriction__select li div', 'Apply any restriction'));
        },
        ...
        getSliderPanel: function() {
            return element(by.css('.se-slider-panel-container'));
        },
        getRestrictionTypeDropdown: function() {
            return element(by.css(restrictionsEditor.constants.RESTRICTION_TYPE_SELECTOR_ID + ' .se-generic-editor-dropdown__match2'));
        },
        ...
        getRestrictionPartOfWorkflowMessage: function(restrictionName) {
            return restrictionsEditor.elements.getRestrictionInListByName(restrictionName).element(by.id('restrictionPartOfWorkflow'));
        }
    };
    ...
    restrictionsEditor.actions = {
        ...
        openRestrictionForEditing: function(restrictionName) {
            return restrictionsEditor.actions.openRestrictionDropdownMenu(restrictionName).then(function() {
                browser.waitForVisibility(restrictionsEditor.elements.getRestrictionEditButtonByName(restrictionName)).then(function() {
        ...
        selectRestrictionType: function(restrictionType) {
            return restrictionsEditor.actions.openRestrictionTypeDropdown()
                .then(function() {
                    browser.waitForVisibility(restrictionsEditor.elements.getRestrictionTypeOption(restrictionType)).then(function(type) {
    ...
    restrictionsEditor.assertions = {
        ...
        assertEditButtonIsHidden: function(restrictionName) {
            browser.waitForAbsence(restrictionsEditor.elements.getRestrictionEditButtonByName(restrictionName));
        },
        assertEditButtonIsVisible: function(restrictionName) {
            expect(restrictionsEditor.elements.getRestrictionEditButtonByName(restrictionName).isPresent()).toBe(true);
        },
        assertRestrictionPartOfWorkflowMessageDisplayed: function(restrictionName) {
            expect(restrictionsEditor.elements.getRestrictionPartOfWorkflowMessage(restrictionName).isPresent()).toBe(true);
        }
    };
