...
module.exports = (function() {
    ...
    componentObject.elements = {
        ...
        getMoreItemsButton: function(componentId) {
            return browser.switchToIFrame().then(function() {
                return element(by.css(componentObject.elements.getSmarteditOverlayCSSMatcherForComponent(componentId) + ".se-ctx-menu-element__btn--more"));
            });
        },
        ...
        getNumContextualMenuItemsForComponentId: function(componentId) {
            return element.all(by.css(componentObject.elements.getSmarteditOverlayCSSMatcherForComponent(componentId) + ".se-ctx-menu-element__btn")).count();
        },
        ...
        getSharedComponentButtonForComponentId: function(componentId) {
            return browser.switchToIFrame().then(function() {
                return element(by.css(componentObject.elements.getSmarteditOverlayCSSMatcherForComponent(componentId) + ".shared-component-button"));
            });
        },
    ...
    componentObject.actions = {
        ...
        clickSharedComponentButton: function(componentId) {
            return browser.switchToIFrame().then(function() {
                return componentObject.elements.getSharedComponentButtonForComponentId(componentId).then(function(sharedComponentButton) {
                    return browser.actions()
    ...
    componentObject.assertions = {
        ...
        assertSharedComponentButtonIsPresent: function(componentId) {
            componentObject.elements.getSharedComponentButtonForComponentId(componentId).then(function(sharedComponentButton) {
