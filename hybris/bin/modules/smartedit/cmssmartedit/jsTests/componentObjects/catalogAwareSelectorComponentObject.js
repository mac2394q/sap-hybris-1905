...
module.exports = (function() {
    ...
    catalogAwareSelector.elements = {
        ...
        getCatalogVersionDropdown: function() {
            return element(by.css('y-select[data-id="se-catalog-version-selector-dropdown"] .se-generic-editor-dropdown__match2'));
        },
        ...
        getItemMoreMenuButton: function(selectorId, itemIndex) {
            return catalogAwareSelector.elements.getListItems(selectorId).get(itemIndex)
                .element(by.css('.y-dropdown-more-menu .y-dropdown-more-menu__toggle'));
        },
        getExpandedDropdownMenu: function() {
            return element(by.css('.y-dropdown-more-menu.open'));
        },
