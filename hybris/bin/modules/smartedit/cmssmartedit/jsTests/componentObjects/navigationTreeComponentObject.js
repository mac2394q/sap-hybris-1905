...
module.exports = {
    ...
    _getNodeTitle: function(nodeLabel) {
        var deferred = protractor.promise.defer();
        var selector = "//div/span[.='" + nodeLabel + "']/ancestor::li[1]/div/div[6]";
    ...
    clickOnLinkHavingClassInRenderer: function(nodeLabel, cssClass) {
        return browser.click(by.xpath("//div/span[.='" + nodeLabel + "']/ancestor::div[2]/div/y-drop-down-menu/div/div[contains(@class, '" + cssClass + "')]"));
    },
