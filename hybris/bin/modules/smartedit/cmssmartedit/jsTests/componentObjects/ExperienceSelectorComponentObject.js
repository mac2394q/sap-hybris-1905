...
module.exports = (function() {
    ...
    experienceSelectorObject.assertions = {
        ...
        experienceSelectorButtonHasText: function(text) {
            expect(experienceSelectorObject.elements.experienceSelectorButtonText()).toContain(text);
        }
    };
    ...
    experienceSelectorObject.elements = {
        ...
        experienceSelectorButtonText: function() {
            return element(by.css('[class*=\'se-experience-selector__btn-text \']', 'Selector widget not found')).getText();
        },
    };
