    ...
    var componentObjects = {
        ...
        assertions: {
            ...
            deletePageItemIsInactive: function() {
                expect(componentObjects.elements.getDeletePageItemAnchor().element(by.css('.se-dropdown-item--delete-link-wrapper--disabled')).isPresent()).toBe(true);
            },
        ...
        elements: {
            getDeletePageItemAnchor: function() {
                ...
                return browser.findElement(by.css(".y-dropdown-more-menu.open .se-dropdown-item--delete-wrapper"));
            },
            getDeletePageItemPopoverAnchor: function() {
                return componentObjects.elements.getDeletePageItemAnchor().element(by.css('.se-dropdown-item--delete-page-popover span'));
            },
