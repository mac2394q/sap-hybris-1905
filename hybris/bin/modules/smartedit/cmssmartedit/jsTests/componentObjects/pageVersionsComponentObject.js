...
module.exports = function() {
    ...
    componentObject.elements = {
        ...
        getPageVersionLabelInToolbarContext: function() {
            return this.getPageVersionToolbarContext().element(by.css('.se-version-item-context__info-label')).getText();
        },
        getRemovePageVersionButton: function() {
            return this.getPageVersionToolbarContext().element(by.css('.se-version-item-context__remove-btn'));
        },
        ...
        getManageVersionsButton: function() {
            return this.getPageVersionsMenu().element(by.css('.se-version-panel__manage-btn'));
        },
        getManageVersionsLink: function() {
            return this.getPageVersionsMenu().element(by.css('.se-version-panel__manage-link'));
        },

        // Search Section
        getVersionsCount: function() {
            return this.getPageVersionsMenu().element(by.css('.se-version-panel__count')).getText();
        },
        getSearchBox: function() {
            return this.getPageVersionsMenu().element(by.css('.se-version-panel__search .se-input-group__input-area'));
        },

        // Versions List
        getEmptyVersionListMsg: function() {
            return this.getPageVersionsMenu().element(by.css('.se-version-panel__empty-list'));
        },
        getVersionsList: function() {
            return this.getPageVersionsMenu().element(by.css('.se-version-panel__infinite-scroll'));
        },
        ...
        getPageVersionsScrollElement: function() {
            return browser.findElement(by.css('.se-version-panel__infinite-scroll > div'));
        },
        ...
        getRollbackSuccessAlert: function() {
            return element(by.css('system-alerts .fd-alert--success'));
        }
    };
    ...
    componentObject.actions = {
        ...
        selectPageVersionByLabel: function(pageVersionLabel) {
            return browser.click(componentObject.elements.getPageVersionLinkByLabel(pageVersionLabel)).then(function() {
                browser.waitUntilNoModal();
    ...
    componentObject.assertions = {
        ...
        manageVersionsButtonIsDisplayed: function() {
            expect(browser.isPresent(componentObject.elements.getManageVersionsButton())).toBe(
                true, "Expected 'Manage' button to be present.");
        },
        ...
        manageVersionsLinkIsDisplayed: function() {
            expect(browser.isPresent(componentObject.elements.getManageVersionsLink())).toBe(
                true, "Expected 'Manage Versions' link to be present.");
        },
