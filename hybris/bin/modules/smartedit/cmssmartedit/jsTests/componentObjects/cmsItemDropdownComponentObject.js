...
module.exports = (function() {
    ...
    componentObject.elements = {
        ...
        getSingleSelectSelectedItemImageById: function(fieldQualifier, itemId) {
            return this.getSingleSelectSelectedItemById(fieldQualifier, itemId).element(by.css('.cms-nested-component__item-icon'));
        },
        ...
        getComponentSubType: function(componentType) {
            return element(by.cssContainingText('sub-type-selector .cms-sub-type__selector-link', componentType));
        },
