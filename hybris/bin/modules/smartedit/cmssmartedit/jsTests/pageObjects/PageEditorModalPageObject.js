...
module.exports = (function() {
    ...
    pageObject.elements = {
        ...
        getElementContainingText: function(text) {
            return element(by.cssContainingText('y-message', text));
        }
    };
    ...
    pageObject.assertions = {
        ...
        assertReadOnlyMessageIsDisplayed: function(message) {
            expect(pageObject.elements.getElementContainingText(message).isPresent()).toBe(true, 'Expected message "' + message + '" to be displayed');
        },
