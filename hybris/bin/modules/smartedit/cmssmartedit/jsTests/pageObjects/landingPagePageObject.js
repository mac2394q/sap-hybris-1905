    ...
    landingPage.assertions = {
        ...
        hasRightSourceVersionIfNecessary: function(catalogName, catalogVersion, syncJobExpectedInfo) {
            if (syncJobExpectedInfo.fromVersion) {
                expect(landingPage.elements.getSyncSourceForCatalogVersion(catalogName, catalogVersion).getText()).toContain(syncJobExpectedInfo.fromVersion, "Invalid sync source");
            }
        },
