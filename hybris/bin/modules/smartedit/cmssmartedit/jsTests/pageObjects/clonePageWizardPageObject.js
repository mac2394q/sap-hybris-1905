...
module.exports = (function() {
    ...
    pageObject.assertions = {
        ...
        assertCloneSuccessAlertIsDisplayed: function() {
            browser.wait(EC.visibilityOf(pageObject.elements.getCloneSuccessAlert()), 5000);
        },
        assertCloneActionableAlertIsDisplayed: function() {
            browser.wait(EC.visibilityOf(pageObject.elements.getCloneInfoAlert()), 5000);
        },
        assertCloneActionableAlertIsNotDisplayed: function() {
            browser.wait(EC.invisibilityOf(pageObject.elements.getCloneInfoAlert()), 5000);
        },
        cloneIconIsDisplayed: function() {
            browser.wait(EC.visibilityOf(pageObject.elements.getClonePageToolbarButton()), 5000);
        },
        cloneIconIsNotDisplayed: function() {
            browser.wait(EC.invisibilityOf(pageObject.elements.getClonePageToolbarButton()), 5000);
        }
    };
