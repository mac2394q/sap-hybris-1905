...
describe('slotSharedService', function() {
    ...
    var $q, $rootScope, harness, pageContentSlotsService, slotSharedService, cmsitemsRestService, pageInfoService, $translate;
    ...
    beforeEach(function() {
        ...
        pageInfoService.getPageUID.and.returnValue(PAGE_UUID);
