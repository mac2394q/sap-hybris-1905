...
describe("Component Shared Service", () => {
	...
	const SLOTS_NOT_FOUND_EXCEPTION_MSG = "ComponentSharedService::isComponentShared - Component must have slots property.";
	...
	it('WHEN component is set-up THEN it must be proxied', () => {
		const decoratorObj = annotationService.getClassAnnotation(ComponentSharedService, GatewayProxied);
