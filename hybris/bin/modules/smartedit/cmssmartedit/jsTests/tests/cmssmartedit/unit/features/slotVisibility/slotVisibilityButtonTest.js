    ...
    describe('when hidden component list is not empty', function() {
        describe('template', function() {
            it('should display the hidden components button', function() {
                ...
                // Assert
                expect(element.find('button.se-slot-ctx-menu__dropdown-toggle--slot-visibility').length)
            ...
            it('should display dropdown menu if the button is clicked', function() {
                ...
                // Act
                element.find('button.se-slot-ctx-menu__dropdown-toggle--slot-visibility').click();

                // Assert
                expect(element.find('.se-slot-ctx-menu__dropdown-toggle-wrapper--slot-visibility .se-slot-visility__component-list').length).toBe(1);
            });
