...
import {CmsApprovalStatus, CMSPageStatus, CMSPageTypes, ICMSPage} from 'cmscommons';
...
describe('pageRestoreModalService', () => {
	...
	beforeEach(() => {
		...
		pageRestoreModalService = new PageRestoreModalService(
			lo, alertService, confirmationModalService, genericEditorModalService, crossFrameEventService,
