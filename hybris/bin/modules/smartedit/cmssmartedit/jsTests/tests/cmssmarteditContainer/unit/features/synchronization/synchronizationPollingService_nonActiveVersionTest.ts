...
describe('Synchronization polling service with content catalog non active version - ', () => {
	...
	const SYNCHRONIZATION_SLOW_POLLING_TIME = SYNCHRONIZATION_POLLING.SLOW_POLLING_TIME;
	const SYNCHRONIZATION_FAST_POLLING_TIME = SYNCHRONIZATION_POLLING.FAST_POLLING_TIME;
