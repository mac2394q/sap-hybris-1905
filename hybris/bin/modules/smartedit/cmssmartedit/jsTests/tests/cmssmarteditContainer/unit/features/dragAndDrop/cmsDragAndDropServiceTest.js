...
describe('cmsDragAndDropService', function() {
    ...
    beforeEach(angular.mock.module('dragAndDropServiceModule', function($provide) {
        $provide.value('inViewElementObserver', null);
    }));
    ...
    beforeEach(angular.mock.module('seConstantsModule', function($provide) {
        $provide.constant('ID_ATTRIBUTE', ID_ATTRIBUTE);
        $provide.constant('UUID_ATTRIBUTE', UUID_ATTRIBUTE);
        $provide.constant('TYPE_ATTRIBUTE', TYPE_ATTRIBUTE);
    }));
