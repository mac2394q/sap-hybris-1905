    ...
    describe('cookie methods', function() {
        ...
        it('GIVEN no cookie is set ' +
            ...
            function() {
                ...
                returnedPromise.then(function(selectedCatalogVersion) {
                    expect(storageService.getValueFromLocalStorage).toHaveBeenCalledWith(jasmine.any(String));
        ...
        it('GIVEN a cookie is set ' +
            ...
            function() {
                ...
                storageService.getValueFromLocalStorage.and.returnValue($q.when(expectedCatalogVersion.id));
        ...
        it('WHEN persistCatalogVersion is called ' +
            ...
            function() {
                ...
                // Assert 
                expect(storageService._setValueInLocalStorage).toHaveBeenCalledWith(jasmine.any(String), catalogVersionToStore);
            });
    });
