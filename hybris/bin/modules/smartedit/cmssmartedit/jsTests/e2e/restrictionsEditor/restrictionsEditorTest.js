...
describe('Restrictions Editor - ', function() {
    ...
    describe('Non-editable in context (because of workflow) restrictions', function() {
        ...
        it('GIVEN list of restrictions AND second restriction is not edited in current context THEN there is no edit button',
            function() {
                // GIVEN
                restrictionsEditor.assertions.listHasExpectedNumberOfRestrictions(2);

                // WHEN
                restrictionsEditor.actions.openRestrictionDropdownMenu(restrictionsEditor.constants.EXISTING_CATEGORY_RESTRICTION_NAME);

                // THEN      
                restrictionsEditor.assertions.assertEditButtonIsHidden(restrictionsEditor.constants.EXISTING_CATEGORY_RESTRICTION_NAME);
                restrictionsEditor.assertions.assertRestrictionPartOfWorkflowMessageDisplayed(restrictionsEditor.constants.EXISTING_CATEGORY_RESTRICTION_NAME);
            });
    });
    ...
    describe('Editable in context (because of workflow) restrictions', function() {
        ...
        it('GIVEN list of restrictions AND second restriction is edited in current context THEN there is no edit button',
            function() {
                // GIVEN
                restrictionsEditor.assertions.listHasExpectedNumberOfRestrictions(2);
                ...
                // THEN      
                restrictionsEditor.assertions.assertEditButtonIsVisible(restrictionsEditor.constants.EXISTING_CATEGORY_RESTRICTION_NAME);
            });
    });
});
