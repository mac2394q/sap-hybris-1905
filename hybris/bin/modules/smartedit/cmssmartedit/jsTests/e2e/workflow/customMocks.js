...
angular.module('customMocksModule', ['backendMocksUtilsModule'])
    .run(function(backendMocksUtils) {
        ...
        backendMocksUtils.getBackendMock('attributesPermissionsGET').respond(function() {
            var customAttributePermissions = Object.keys(sessionStorage).filter(function(key) {
        ...
        function setupWorkflowTasks() {
            ...
            backendMocksUtils.getBackendMock('workflowInboxTasksGETMock').respond(function() {
