...
describe('Page approval selector - \n', function() {
    ...
    function removeActiveWorkflow(removeWorkflow) {
        browser.executeScript('window.sessionStorage.setItem("removeActiveWorkflow", ' + removeWorkflow + ')');
    }
    ...
    function makePageDraft() {
        ...
        browser.executeScript('window.sessionStorage.setItem("updatePageApprovalStatus", arguments[0])', JSON.stringify(pageUpdates));
