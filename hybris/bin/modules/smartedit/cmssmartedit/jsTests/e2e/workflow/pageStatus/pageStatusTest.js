...
describe('Page Status - \n', function() {
    ...
    describe('Staged Page - ', function() {
        ...
        it('GIVEN page is in progress WHEN page is loaded THEN the page status will be as in progress', function() {
            // GIVEN 
            pageStatus.utils.setMockPageDisplayStatus(pageStatus.constants.IN_PROGRESS_DISPLAY_STATUS);
            navigateToPage();
        ...
        it('GIVEN page is ready to be synced WHEN page is loaded THEN the page status will be as ready to sync', function() {
            // GIVEN 
            pageStatus.utils.setMockPageDisplayStatus(pageStatus.constants.READY_TO_SYNC_DISPLAY_STATUS);
            navigateToPage();
    ...
    function navigateToOnlinePage(done) {
        return navigateToPage().then(function() {
            ...
            landingPage.actions.navigateToCatalogHomepage(landingPage.constants.APPAREL_UK_CATALOG, landingPage.constants.ACTIVE_CATALOG_VERSION);
    ...
    function navigateToOnlinePageList() {
        return navigateToPage().then(function() {
            sitesLink.actions.openSitesPage();
            landingPage.actions.navigateToCatalogPageList(landingPage.constants.APPAREL_UK_CATALOG, landingPage.constants.ACTIVE_CATALOG_VERSION);
        });
    }
    ...
    function navigateToStagedPageList() {
        return navigateToPage().then(function() {
            sitesLink.actions.openSitesPage();
            landingPage.actions.navigateToCatalogPageList(landingPage.constants.APPAREL_UK_CATALOG, landingPage.constants.STAGED_CATALOG_VERSION);
        });
    }
