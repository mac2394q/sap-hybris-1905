...
angular
    ...
    .run(
        function($httpBackend, parseQuery, backendMocksUtils, navigationNodePOST, navigationNodeNodes) {
            ...
            var getComponentsByUuidsPOSTMock = $httpBackend.whenPOST(/\/cmswebservices\/v1\/sites\/.*\/cmsitems\/uuids/);
            ...
            backendMocksUtils.storeBackendMock('getComponentsByUuidsPOSTMock', getComponentsByUuidsPOSTMock);
