...
window.__smartedit__.i18nMocks = {
    en_US: {
        ...
        "se.cms.pageeditormodal.page.readonly.message": "This page is part of a workflow and cannot be edited.",
        ...
        'se.cms.workflow.cancel.confirmation.description': 'When canceling workflow, the page will be moved back to Draft',
        ...
        'se.cms.alert.component.removed.from.slot': 'The component {{componentID}} has been removed from slot {{slotID}}',
        ...
        'se.cms.actionitem.page.permanently.delete.blocked': 'The page must be synched before permanently deleting it.',
        'se.cms.sync.page.status.confirm.title': 'Sync Page Status',
        'se.cms.sync.page.status.confirm.description': 'Do you want to sync the page status to the {{catalogVersion}} catalog version? This will update the page status to "DELETED" in {{catalogVersion}} catalog version.',
        'se.cms.sync.page.status.success.alert': '{{pageId}} page has be successfully trashed in {{catalogVersion}} catalog version.',
        'se.cms.pagelist.headerpagestatus': 'Status',
        'se.cms.tooltip.current.homepage.movetotrash': 'This is the homepage. It cannot be moved to trash.'
    }
};
