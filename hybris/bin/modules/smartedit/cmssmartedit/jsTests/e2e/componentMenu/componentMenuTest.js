...
describe('Component Menu', function() {
    ...
    describe('GIVEN user has permission to write in page', function() {
        ...
        describe('AND page has more than one catalogs', function() {
            ...
            it('GIVEN existing component is not shared WHEN displayed in component menu THEN it does not show a shared component indicator', function() {
                // GIVEN 
                var componentId = 'Component4';
                componentMenu.actions.openMenu();
                componentMenu.actions.selectComponentsTab();

                // WHEN 
                componentMenu.actions.searchComponents(componentId);

                // THEN 
                componentMenu.assertions.assertExistingComponentIsNotShared(componentId);
            });

            it('GIVEN existing component is shared WHEN displayed in component menu THEN it shows a shared component indicator', function() {
                // GIVEN 
                var componentId = 'Component8';
                componentMenu.actions.openMenu();
                componentMenu.actions.selectComponentsTab();
                ...
                // THEN 
                componentMenu.assertions.assertExistingComponentIsShared(componentId);
            });
        });
    });
