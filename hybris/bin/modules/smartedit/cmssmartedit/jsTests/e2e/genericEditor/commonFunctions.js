...
getMediaElement = function(language) {
    return element(by.css('[id="media"] y-tab[data-tab-id="' + language + '"] .se-media-preview__image-thumbnail'));
};

getMediaElementWrapper = function(language) {
    return element(by.css('[id="media"] y-tab[data-tab-id="' + language + '"] .se-media-selector__left-section'));
};

assertOnMediaInTab = function(language, expectedContent) {
    return selectMediaTab(language).then(function() {
        return browser.click(getMediaElementInfoAncor(language)).then(function() {
            return getMediaElementCode().getText().then(function(content) {
...
getMediaElementInfoAncor = function(language) {
    return element(by.css('[id="media"] y-tab[data-tab-id="' + language + '"] .se-media__advanced-info'));
};
