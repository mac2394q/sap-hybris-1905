...
describe("GenericEditor Media Upload Container", function() {
    ...
    it('WHEN I select an inflection point and select a file to upload ' +
        ...
        function() {
            selectFileToUpload('more_bckg.png', '.widescreen .se-media--present input[type="file"]');
    ...
    it('WHEN I select an inflection point with an existing image and upload  ' +
        ...
        function() {
            ...
            expect(element(by.css('.widescreen .se-media--present .se-media-preview__image-thumbnail')).getAttribute('data-ng-src')).toContain('more_bckg.png');
            expect(element(by.css('.widescreen .se-media--present .se-media-preview__image-thumbnail')).getAttribute('src')).toContain('more_bckg.png');
        });
    ...
    it('WHEN I select an inflection point with no image selected and upload  ' +
        ...
        function() {
            ...
            browser.waitForAbsence(by.css('se-media-upload-form'));
            expect(element(by.css('.mobile .se-media--present .se-media-preview__image-thumbnail')).getAttribute('data-ng-src')).toContain('more_bckg.png');
            expect(element(by.css('.mobile .se-media--present .se-media-preview__image-thumbnail')).getAttribute('src')).toContain('more_bckg.png');
        });
