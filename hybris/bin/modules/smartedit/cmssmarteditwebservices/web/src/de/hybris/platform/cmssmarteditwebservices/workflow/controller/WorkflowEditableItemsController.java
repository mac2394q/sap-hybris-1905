...
@RestController
@RequestMapping(API_VERSION + "/catalogs/{catalogId}/versions/{versionId}/workfloweditableitems")
public class WorkflowEditableItemsController
{
	...
	public CMSWorkflowEditableItemListWsDTO getEditableWorkflowItems(
			@ApiParam(value = "List of item uids", required = true) @RequestParam("itemUids") final List<String> itemUids
	) {
		...
		currentUserEditableItemListWsDTO.setEditableItems(getDataMapper().mapAsList(editableItems, CMSWorkflowEditableItemWsDTO.class, null));
