...
export class SmarteditloaderComponent {
	...
	ngAfterViewInit() {
		...
		this.upgrade.bootstrap(this.elementRef.nativeElement.querySelector(legacyLoaderTagName), [(Smarteditloader as SeModuleConstructor).moduleName], {strictDi: false});
	}
}
