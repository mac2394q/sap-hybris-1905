...
export class SeRouteService {
	 ...
	 * @description
	 * Adds new Angular route to the application. For more inforamtion please see documentation for RouterModule.forRoot.
	 * 
	 ...
	 */
	private static generateRouteShortcutConfig(configs: SeRouteShortcutConfig[], routes: SeRoutes, parent: string = "") {
	 ...
	 */
	private static canRegisterRouteShortcutConfig(routeShortcutConfig: SeRouteShortcutConfig): boolean {
