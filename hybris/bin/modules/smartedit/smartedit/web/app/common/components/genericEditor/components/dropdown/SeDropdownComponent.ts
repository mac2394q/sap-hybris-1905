...
export class SeDropdownComponent implements ISeComponent {
	...
	$onInit(): void {
		...
		this.field.params.catalogId =
			this.field.params.catalogId || this.CONTEXT_CATALOG;
		this.field.params.catalogVersion =
			this.field.params.catalogVersion || this.CONTEXT_CATALOG_VERSION;
