...
describe('NamepsaceStorageManager', () => {
	...
	describe('Decorates the StorageManager', () => {
		...
		const namespacedStorageId = StorageNamespaceConverter.getNamespacedStorageId(NAMESPACE, STORAGE_ID);
		...
		it('decorates registerStorageController method', (done) => {
			tryFinally(() => nsStorageManager.registerStorageController(dummyController),
				() => {
		...
		it('decorates getStorage method', (done) => {
			tryFinally(() => nsStorageManager.getStorage(storageConf),
				() => {
		...
		it('decorates hasStorage method', (done) => {
			tryFinally(() => nsStorageManager.hasStorage(STORAGE_ID),
				() => {
