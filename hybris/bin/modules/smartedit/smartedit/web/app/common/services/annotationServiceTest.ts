...
describe('test annotationService', function() {
	...
	describe('class annotations', () => {
		...
		it('GIVEN a constructor is annotated but not @SeInjectable hinted, an exception will be thrown', () => {
			...
			}).toThrow(new Error("NonHintedClass class was decorated with annotation classAnnotation2 but has probably not been annotated with @Injectable(), @SeInjectable() or @SeComponent"));
