...
describe('http error predicates', function() {
    var serverErrorPredicate;
    var SERVER_ERROR_PREDICATE_HTTP_STATUSES;
    var clientErrorPredicate;
    var CLIENT_ERROR_PREDICATE_HTTP_STATUSES;
    var timeoutErrorPredicate;
    var TIMEOUT_ERROR_PREDICATE_HTTP_STATUSES;
