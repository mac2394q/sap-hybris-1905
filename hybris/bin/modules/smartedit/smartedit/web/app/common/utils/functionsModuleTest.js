...
describe('functionsModule', function() {
    ...
    var closeOpenModalsOnBrowserBack;
    var $uibModalStack;
    var isAllTruthy;
    var isAnyTruthy;
    var compareHTMLElementsPosition;
    var deepObjectPropertyDiff;
    var deepIterateOverObjectWith;
    var sanitize;
    ...
    beforeEach(inject(function(
        ...
        _uniqueArray_,
        _regExpFactory_,
        _generateIdentifier_,
        _escapeHtml_,
        _closeOpenModalsOnBrowserBack_,
        _getDataFromResponse_,
        _getKeyHoldingDataFromResponse_,
        _isAllTruthy_,
        _isAnyTruthy_,
        _compareHTMLElementsPosition_,
        _deepObjectPropertyDiff_,
        _deepIterateOverObjectWith_,
        _sanitize_
    ) {
    ...
    it('escapeHtml will escape dangerous characters from a given string', function() {
        ...
        var _string = escapeHtml("hello<button>&'\"");
