...
angular.module('toolbarModule', ['resourceLocationsModule', 'toolbarInterfaceModule', 'translationServiceModule', 'iframeClickDetectionServiceModule', 'smarteditServicesModule', 'seConstantsModule'])
     ...
     */
    .directive('toolbar', function(toolbarServiceFactory, STORE_FRONT_CONTEXT, $location, $timeout, iframeClickDetectionService, CLOSE_ALL_ACTION_ITEMS, EVENTS, systemEventService) {
        return {
            ...
            link: function(scope) {
                ...
                scope.populatePermissions = function() {
                    scope.actions.forEach(function(action) {
                        toolbarService._populateIsPermissionGranted(action);
                    });
                };

                scope.populatePermissions();
                ...
                this.unregCloseActions = iframeClickDetectionService.registerCallback(CLOSE_ALL_ACTION_ITEMS + scope.toolbarName, function() {
                ...
                this.permissionCacheClearedEvent = systemEventService.subscribe(EVENTS.PERMISSION_CACHE_CLEANED, function() {
                    scope.populatePermissions();
                }.bind(this));
                ...
                scope.$on("$destroy", function() {
                    ...
                    this.unregOverlay();
                    this.unregCloseAll();
                    this.permissionCacheClearedEvent();
                }.bind(this));
            }
        };
    });
