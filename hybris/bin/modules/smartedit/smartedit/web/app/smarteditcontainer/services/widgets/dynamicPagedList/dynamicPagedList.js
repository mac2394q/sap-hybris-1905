...
(function() {
     ...
     *
     */
    angular.module('dynamicPagedListModule', ['pascalprecht.translate', 'ui.bootstrap', 'legacySmarteditCommonsModule', 'seConstantsModule', 'ngSanitize', 'paginationFilterModule',
         ...
         * ```
         * 
         * @param {<Object=} config.queryParams An object containing list of query params that needed to be passed to the uri.
         ...
         * @param {<Object?} onItemsUpdate Exposes the dynamic paged list module's api object
         *
         * @example
