...
import {IModalService, SeInjectable, TypedMap} from 'smarteditcommons';
import {Configuration, ConfigurationItem} from 'smarteditcontainer/services/bootstrap/Configuration';
import {ConfigurationModalController} from '../components/generalConfiguration/ConfigurationModalController';
...
export class ConfigurationService {
	...
	constructor(
		...
		private MODAL_BUTTON_ACTIONS: TypedMap<any>,
		private MODAL_BUTTON_STYLES: TypedMap<any>
	) {
