...
module.exports = function () {
    ...
    paths.watchFiles = ['web/app/common/**/*', 'web/app/smartedit/**/*', 'web/app/smarteditcontainer/**/*'];

    /**
     * Task: COPY: toDummystorefront
     */
    paths.copyToDummystorefront = bundlePaths.bundleRoot + '/test/e2e/dummystorefront/imports/generated/';
    ...
    const tsConfingIncludeSmarteditContainer = ["../../jsTarget/web/app/smarteditcontainer/**/*", "../../jsTarget/web/app/smarteditloader/**/*"];
    ...
    paths.tsConfigInclude.test = {
        smartedit: paths.tsConfigInclude.sources.smartedit
            .concat(["../../test/unit/smartedit/unit/**/*", bundleUnitTestFiles]),
        smarteditContainer: paths.tsConfigInclude.sources.smarteditContainer
            .concat(["../../test/unit/smarteditcontainer/unit/**/*", bundleUnitTestFiles]),
        common: paths.tsConfigInclude.sources.common
            .concat(["../../web/app/common/**/*" + bundlePaths.test.testFileSuffix + ".ts", bundleUnitTestFiles])
    };
