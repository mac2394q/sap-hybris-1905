import { ILanguage, IUriContext } from "smarteditcommons/services";
import { Payload, Primitive, TypedMap } from "smarteditcommons/dtos";
...
export declare type GenericEditorPredicate = (structure: GenericEditorStructure) => boolean;
