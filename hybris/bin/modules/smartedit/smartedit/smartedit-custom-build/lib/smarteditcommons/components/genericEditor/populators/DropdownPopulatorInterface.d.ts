...
import { DropdownPopulatorFetchPageResponse, DropdownPopulatorItemPayload, DropdownPopulatorPagePayload, DropdownPopulatorPayload, GenericEditorOption, IDropdownPopulator } from "../..";
...
export declare class DropdownPopulatorInterface implements IDropdownPopulator {
    ...
    constructor(lodash: lo.LoDashStatic, languageService: LanguageService);
