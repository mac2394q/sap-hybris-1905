...
module.exports = {
    commons: () => group(
        entry({
            smarteditcommons: [
                resolve(bundlePaths.external.generated.commons.lib)
            ]
        }),
        output({
    ...
    smartedit: () => group(
        ...
        set('output.path', resolve(customPaths.web.webroot.staticResources.dir + '/dist/smartedit/js')), 
    ...
    smarteditContainer: () => group(
        ...
        set('output.path', resolve(customPaths.web.webroot.staticResources.dir + '/dist/smarteditcontainer/js')), 
        alias('smarteditcontainer', resolve(customPaths.smarteditcontainerproperties.smarteditcontainer)),
