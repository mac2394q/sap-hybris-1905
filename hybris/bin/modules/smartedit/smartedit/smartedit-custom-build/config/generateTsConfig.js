...
module.exports = function() {
    ...
    return {
        ...
        config: function(data, conf) {
			...
			const tsConfigTemplates = require('../../smartedit-build/config/templates').tsConfigTemplates;
            ...
            conf.generateLibSmarteditCommonsTsConfig.data.include = paths.tsConfigInclude.sources.common;
            conf.generateLibSmarteditCommonsTsConfig.data.exclude = paths.tsConfigExclude.sources.common;
            addTypesDeclarationAndRemovePathsAndTypeRoots(conf.generateLibSmarteditCommonsTsConfig.data, [{
                "smarteditcommons/*": ["web/app/common/*"],
            }], false);
            ...
            overrideSmarteditCommonsWithInternalPath(conf.generateProdSmarteditContainerTsConfig.data);
            conf.generateProdSmarteditTsConfig.data.include = paths.tsConfigInclude.sources.smartedit;
            conf.generateProdSmarteditTsConfig.data.compilerOptions.declarationDir = "../../temp/types/smartedit";
            conf.generateProdSmarteditContainerTsConfig.data.include = paths.tsConfigInclude.sources.smarteditContainer;
            ...
            overrideSmarteditCommonsWithInternalPath(conf.generateDevSmarteditContainerTsConfig.data);
            conf.generateDevSmarteditTsConfig.data.include = paths.tsConfigInclude.sources.smartedit;
            conf.generateDevSmarteditTsConfig.data.compilerOptions.declarationDir = "../../temp/types/smartedit";
            conf.generateDevSmarteditContainerTsConfig.data.include = paths.tsConfigInclude.sources.smarteditContainer;
            ...
            addTypesDeclarationAndRemovePathsAndTypeRoots(conf.generateKarmaSmarteditcommonsTsConfig.data, smarteditcommonsPaths, false);

            overrideSmarteditCommonsWithInternalPath(conf.generateKarmaSmarteditTsConfig.data);
            overrideSmarteditCommonsWithInternalPath(conf.generateKarmaSmarteditContainerTsConfig.data);

            conf.generateKarmaSmarteditTsConfig.data.include = paths.tsConfigInclude.test.smartedit;
            conf.generateKarmaSmarteditContainerTsConfig.data.include = paths.tsConfigInclude.test.smarteditContainer;
            conf.generateKarmaSmarteditcommonsTsConfig.data.include = paths.tsConfigInclude.test.common;
            ...
            // ======== IDE ========
            addTypesDeclarationAndRemovePathsAndTypeRoots(conf.generateIDETsConfig.data, [smarteditPaths, smarteditContainerPaths, smarteditCommonsPaths], false);
            conf.generateIDETsConfig.data.include = conf.generateIDETsConfig.data.include.concat(paths.tsConfigInclude.ide);
            ...
            const angularStorefrontInclude = [global.smartedit.bundlePaths.bundleRoot+"/test/e2e/dummystorefront/angular/**/*"];
            addTypesDeclarationAndRemovePathsAndTypeRoots(conf.generateAngularStorefrontTsConfig.data, [], false);
            conf.generateAngularStorefrontTsConfig.data.include = angularStorefrontInclude;
            conf.generateAngularStorefrontTsConfig.data.compilerOptions.baseUrl = global.smartedit.bundlePaths.bundleRoot + '/test/e2e/dummystorefront/angular';
