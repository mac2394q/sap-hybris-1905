...
describe('test outer toolbarService Module', function() {
    ...
    var $rootScope, $q, $log, gatewayProxy, toolbarServiceFactory, permissionService;
    ...
    beforeEach(inject(function(_$rootScope_, _$q_, _$log_, _toolbarServiceFactory_, _permissionService_) {
