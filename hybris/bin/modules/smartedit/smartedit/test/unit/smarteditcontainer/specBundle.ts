...
importAll(require.context('../../utils', true, /outerTestDowngradedModule\.ts$/));
importAll(require.context('../../../jsTarget/web/app/smarteditcontainer', true, /(SmarteditServicesModule|administrationModule|CatalogDetailsModule)\.ts$/));
