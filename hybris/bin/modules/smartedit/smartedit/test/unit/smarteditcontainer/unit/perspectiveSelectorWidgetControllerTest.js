...
describe('PerspectiveSelectorController', function() {
    ...
    var $componentController, PerspectiveSelectorController,
        ...
        unRegOverlayDisabledFn, unRegPerspectiveAddedFn, unRegPerspectiveChgFn, unRegPerspectiveRefreshFn, unRegUserHasChanged,
        unRegStrictPreviewModeToggleFn, EVENT_STRICT_PREVIEW_MODE_REQUESTED, $q;
    ...
    beforeEach(inject(function(_$componentController_, _EVENT_PERSPECTIVE_ADDED_, _EVENT_PERSPECTIVE_CHANGED_, _EVENT_PERSPECTIVE_REFRESHED_, _ALL_PERSPECTIVE_, _EVENTS_, _EVENT_STRICT_PREVIEW_MODE_REQUESTED_, _$q_) {
        ...
        EVENT_STRICT_PREVIEW_MODE_REQUESTED = _EVENT_STRICT_PREVIEW_MODE_REQUESTED_;
    ...
    describe('initialization', function() {
        it('controller is initialized with correct data', function() {
            ...
            expect(PerspectiveSelectorController.isDisabled).toBe(false);
        ...
        it('$onInit subscribes to EVENT_STRICT_PREVIEW_MODE_REQUESTED on crossFrameEventService', function() {
            // GIVEN/WHEN
            PerspectiveSelectorController.$onInit();
    ...
    describe('destruction', function() {
        ...
        it('$onDestroy un-registers the EVENT_STRICT_PREVIEW_MODE_REQUESTED from crossFrameEventService', function() {
            // GIVEN
            PerspectiveSelectorController.$onInit();
    ...
    describe('isTooltipVisible', function() {
        ...
        it('returns false when preview perspective is active and perspective selector is not disabled', function() {
            // GIVEN
            var PERSPECTIVE_1 = {
                key: 'se.none',
                descriptionI18nKey: 'some.description.key'
        ...
        it('returns true when preview perspective is active and perspective selector is disabled', function() {
            // GIVEN
            var PERSPECTIVE_1 = {
                key: 'se.none',
                descriptionI18nKey: 'some.description.key'
            ...
            perspectiveService.getActivePerspective.and.returnValue(PERSPECTIVE_1);
            PerspectiveSelectorController._refreshActivePerspective();
            PerspectiveSelectorController.togglePerspectiveSelector(true);
