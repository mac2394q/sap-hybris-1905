...
describe('notificationMouseLeaveDetectionService', () => {
	...
	const windowUtils: jasmine.SpyObj<WindowUtils> = jasmine.createSpyObj<WindowUtils>('windowUtils', ['getTargetIFrame']);
	...
	beforeEach(() => {
		notificationMouseLeaveDetectionService = new NotificationMouseLeaveDetectionService($document, $q, windowUtils);
		windowUtils.getTargetIFrame.and.returnValue({});
	});
