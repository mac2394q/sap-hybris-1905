...
import {DropdownPopulatorPayload, LanguageService, OptionsDropdownPopulator} from 'smarteditcommons';
...
describe('optionsDropdownPopulator', function() {
	...
	beforeEach(() => {
		...
		optionsDropdownPopulator = new OptionsDropdownPopulator(lo, $q, languageService);
	});
