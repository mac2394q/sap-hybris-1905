...
describe('componentHandlerService - inner', () => {
	...
	describe('getFirstSmartEditComponentChildren', () => {
		const PARENT_CSS_PATH = "body > main > .smartEditComponent";
		const FIRST_LEVEL_CHILD_PATH = "body > main > .smartEditComponent > .smartEditComponent";
		const DEEP_LEVEL_CHILD_PATH = "body > main > .smartEditComponent > div > ul > .smartEditComponent";
		const DEEP_LEVEL_NESTED_CHILD_PATH = "body > main > .smartEditComponent > div > .smartEditComponent > ul > .smartEditComponent";
		const NON_CHILD_PATH = "body > ul > .smartEditComponent > .smartEditComponent";

		let parentComponent: jasmine.SpyObj<any>;
		...
		beforeEach(() => {
			...
			let callCount = -1;
			yjQuery.and.callFake(() => {
				callCount++;
				const callReturnValues = [parentComponent].concat(childComponents);
