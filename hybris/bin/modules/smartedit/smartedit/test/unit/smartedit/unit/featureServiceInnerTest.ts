...
describe('inner featureService', () => {
	...
	const contextualMenuService = jasmine.createSpyObj('contextualMenuService', ['addItems', 'removeItemByKey', 'containsItem']);
	...
	beforeEach(() => {
		...
		featureService = new FeatureService($log, decoratorService, lo, cloneableUtils, $q, contextualMenuService);
