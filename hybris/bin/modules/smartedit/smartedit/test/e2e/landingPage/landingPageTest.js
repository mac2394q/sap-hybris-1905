...
describe('Landing Page - ', function() {
    ...
    var inflectionPoint = require('../utils/components/InflectionPoint.js');
    var landingPage = require('../utils/pageObjects/LandingPagePageObject.js');

    beforeEach(function(done) {
        landingPage.actions.openAndBeReady(done);
    });
    ...
    it('GIVEN I am on the landing page ' +
        ...
        function() {
            // WHEN
            landingPage.actions.selectSite(landingPage.constants.ELECTRONICS_SITE);
