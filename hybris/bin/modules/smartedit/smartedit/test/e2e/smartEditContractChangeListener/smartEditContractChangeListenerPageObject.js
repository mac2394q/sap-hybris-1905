...
module.exports = (function() {
    ...
    page.elements = {
        ...
        getTotalDecorators: function() {
            return element(by.id('total-decorators')).getText();
        },
        ...
        createSimpleDivElementButton: function() {
            return element(by.id('createSimpleDivElement'));
        },
        convertSimpleDivToComponentButton: function() {
            return element(by.id('convertSimpleDivToComponent'));
        },
        convertComponentToSimpleDivButton: function() {
    ...
    page.actions = {
        ...
        createSimpleDivElement: function() {
            return forceClickThroughOverlay(page.elements.createSimpleDivElementButton());
        },
        convertSimpleDivToComponent: function() {
            return forceClickThroughOverlay(page.elements.convertSimpleDivToComponentButton());
        },
        convertComponentToSimpleDiv: function() {
            return forceClickThroughOverlay(page.elements.convertComponentToSimpleDivButton());
        }
    };
    page.assertions = {
        ...
        overlayAndStoreFrontAreSynced: function() {
            ...
            browser.waitUntil(function() {
                return protractor.promise.all([page.elements.getTotalDecorators(), page.elements.getTotalSakExecutorElements()]).then(function(array) {
