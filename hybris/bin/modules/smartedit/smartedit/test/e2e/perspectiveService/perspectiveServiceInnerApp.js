...
angular.module('permissionDisplayComponent', [])
    .directive('permissionDisplayDecorator', function() {
        return {
            template: '<div>Test permission component <div data-ng-transclude></div></div>',
            transclude: true,
            restrict: 'C'
        };
    });
...
angular.module('permissionRegisteredInnerDecoratorModule', [])
    .directive('permissionRegisteredInnerDecorator', function() {
        return {
            template: '<div>Test permission decorator registered inner <div data-ng-transclude></div></div>',
            transclude: true,
            restrict: 'C'
        };
    });
