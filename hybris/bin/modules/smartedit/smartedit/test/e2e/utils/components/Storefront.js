...
module.exports = (function() {
    ...
    storefrontObject.assertions = {
        ...
        assertDecoratorShowsOnComponent: function(componentId, componentType, decoratorClasses) {
            decoratorClasses = typeof decoratorClasses === 'string' ? [decoratorClasses] : decoratorClasses;
            storefrontObject.actions.moveToComponent(componentId, componentType);
            decoratorClasses.forEach(function(decoratorClass) {
        ...
        assertDecoratorDoesntShowOnComponent: function(componentId, componentType, decoratorClasses) {
            decoratorClasses = typeof decoratorClasses === 'string' ? [decoratorClasses] : decoratorClasses;
            decoratorClasses.forEach(function(decoratorClass) {
                browser.waitForAbsence(by.css(_buildDecoratorSelector(componentId, componentType, decoratorClass)), "should not have found decorator " + decoratorClass);
            });
        }
    };
