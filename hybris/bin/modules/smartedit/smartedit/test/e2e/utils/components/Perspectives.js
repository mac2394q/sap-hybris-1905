...
module.exports = (function() {
    ...
    perspectiveSelectorObject.assertions = {
        ...
        assertPerspectiveSelectorButtonIsDisabled: function() {
            browser.waitForPresence(perspectiveSelectorObject.elements.getPerspectiveDropdownToggle()).then(function() {
                expect(perspectiveSelectorObject.elements.getPerspectiveDropdownToggle().isEnabled()).toBeFalsy();
            });
        },

        assertPerspectiveSelectorToolTipIsPresent: function() {
            browser.waitForPresence(perspectiveSelectorObject.elements.getTooltipIcon());
        }
