 ...
 */
angular.module('DummyDecoratorsModule', ['textDisplayDecorator', 'slotTextDisplayDecorator', 'buttonDisplayDecorator', 'slotButtonDisplayDecorator', 'pageSpecificDecorator', 'buttonDisplayAndRefreshDecorator'])
...
angular.module('buttonDisplayAndRefreshDecorator', ['DummyDecoratorTemplatesModule', 'translationServiceModule', 'smarteditServicesModule'])
    .directive('buttonDisplayAndRefresh', function(crossFrameEventService, EVENT_SMARTEDIT_COMPONENT_UPDATED) {
        return {
...
angular.module('DummyDecoratorTemplatesModule', [])
    .run(function($templateCache) {
        ...
        $templateCache.put('buttonAndRefreshDecoratorTemplate.html',
            "<div>\n" +
            "<div data-ng-transclude></div>\n" +
