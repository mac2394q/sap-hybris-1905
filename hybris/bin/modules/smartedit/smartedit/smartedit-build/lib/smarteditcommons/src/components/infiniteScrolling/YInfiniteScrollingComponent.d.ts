...
import { DiscardablePromiseUtils } from 'smarteditcommons/utils';
...
export declare class YInfiniteScrollingComponent<T extends ITechnicalUniqueIdAware> implements ISeComponent {
    ...
    constructor($timeout: angular.ITimeoutService, encode: (object: any) => string, lodash: lo.LoDashStatic, discardablePromiseUtils: DiscardablePromiseUtils, $element: JQuery<Element>, generateIdentifier: () => string, throttle: (func: (...args: any[]) => any, maxWait: number) => any, testModeService: TestModeService);
}
