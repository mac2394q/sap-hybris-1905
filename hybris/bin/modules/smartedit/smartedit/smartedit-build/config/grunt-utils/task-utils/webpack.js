    ...
    const webpackUtil = {
        ...
        disableTsLoaderTranspileOnly: (webpackConfig) => {
            ...
            if (webpackConfig.module && webpackConfig.module.rules) {
                const typeScriptRule = webpackConfig.module.rules.find((rule) => {
                    return rule.use ? rule.use.find(loaderConfig => loaderConfig.loader === tsLoaderName) : false;
                });
                const tsLoader = typeScriptRule.use.find(loaderConfig => loaderConfig.loader === tsLoaderName);
        ...
        ngAnnotatePlugin: {
            ...
            apply: function(compiler) {
                const {
                    ngAnnotatePlugin
                } = require('../../smartedit-build/builders/webpack');
