    ...
    return {
        ...
        config: function(data, conf) {
            ...
            conf.generateProdSmarteditWebpackConfig = {
                ...
                data: compose(
                    prod(),
                    tsLoader(resolve(bundlePaths.external.generated.tsconfig.prodSmartedit), false, false, false)
                )(webpackBaseConfig)
            };
            ...
            conf.generateProdSmarteditContainerWebpackConfig = {
                ...
                data: compose(
                    prod(),
                    tsLoader(resolve(bundlePaths.external.generated.tsconfig.prodSmarteditContainer), false, false, false)
                )(webpackBaseConfig)
            };
            ...
            conf.generateDevSmarteditWebpackConfig = {
                ...
                data: compose(
                    dev(),
                    tsLoader(resolve(bundlePaths.external.generated.tsconfig.devSmartedit), false, false, false)
                )(webpackBaseConfig)
            };
            ...
            conf.generateDevSmarteditContainerWebpackConfig = {
                ...
                data: compose(
                    dev(),
                    tsLoader(resolve(bundlePaths.external.generated.tsconfig.devSmarteditContainer), false, false, false)
                )(webpackBaseConfig)
            };
            ...
            setSmarteditCommonsForLibrary(conf.generateKarmaSmarteditContainerWebpackConfig.data, false);
