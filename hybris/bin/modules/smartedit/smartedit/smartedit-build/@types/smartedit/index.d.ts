...
export class ContextualMenuController extends BaseContextualMenuController implements angular.IController {
    ...
    constructor($element: JQuery<HTMLElement>, REFRESH_CONTEXTUAL_MENU_ITEMS_EVENT: any, CLOSE_CTX_MENU: string, contextualMenuService: ContextualMenuService, systemEventService: SystemEventService, componentHandlerService: ComponentHandlerService);
    $doCheck: () => void;
    $onDestroy(): void;
    $postLink(): void;
    onInit(): void;
...
export class SlotContextualMenuController extends BaseContextualMenuController implements ISeComponent {
    ...
    constructor($timeout: angular.ITimeoutService, $element: JQuery<HTMLElement>, SHOW_SLOT_MENU: string, HIDE_SLOT_MENU: string, REFRESH_CONTEXTUAL_MENU_ITEMS_EVENT: string, systemEventService: SystemEventService, contextualMenuService: ContextualMenuService, permissionService: PermissionService, yjQuery: JQueryStatic, throttle: (func: (...args: any[]) => any, maxWait: number) => any);
...
export class DecoratorService {
    ...
    constructor(promiseUtils: PromiseUtils, stringUtils: StringUtils, legacyDecoratorToCustomElementConverter: LegacyDecoratorToCustomElementConverter);
    /**
     * @ngdoc method
...
export class PermissionService extends IPermissionService {
    ...
    _remoteCallRuleVerify(ruleKey: string, permissionNameObjs: PermissionContext[]): any;
}
...
export class SakExecutorService {
    ...
    decoratorsCondition: string;
    constructor(decoratorService: DecoratorService, windowUtils: WindowUtils);
...
export class SmarteditElementComponent {
    ...
    constructor(upgradeModule: UpgradeModule, elementRef: ElementRef, sakExecutorService: SakExecutorService, systemEventService: SystemEventService, crossFrameEventService: CrossFrameEventService);
    ngOnInit(): void;
    ngAfterViewInit(): void;
    ngOnDestroy(): void;
