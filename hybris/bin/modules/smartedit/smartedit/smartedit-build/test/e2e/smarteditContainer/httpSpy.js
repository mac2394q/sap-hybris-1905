 ...
 */
(function(angular) {
    angular.module('httpSpyInterceptorModule', [])
                ...
                this.track = function(method, url) {
                    ...
                    Object.keys(this.requests).forEach(function(key) {
                        ...
                        if (total >= HTTP_SPY_MAX_XHR_REQUESTS) {
                            console.error('WARNING: too much xhr calls to ' + url + ' - method:' + method + ' - total:' + total + ' calls in the current test alone, please fix it before committing.');
                            return;
                        }
                    }.bind(this));
                };
