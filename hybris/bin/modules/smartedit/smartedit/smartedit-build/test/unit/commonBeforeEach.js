    ...
    var PromiseMatcherHelper = {
        ...
        getPromiseInfo: function(promise) {
            ...
            if (promise.__zone_symbol__state != undefined) {
                promiseInfo.status = promise.__zone_symbol__state ? that.states.RESOLVED : that.states.REJECTED;
...
window.addModulesIfNotDeclared(['legacySmarteditCommonsModule', 'smarteditServicesModule', 'alertServiceModule', 'authenticationModule']);
 ...
 */
beforeEach(angular.mock.module('legacySmarteditCommonsModule', function($provide, $injector) {
...
beforeEach(angular.mock.module('smarteditServicesModule', function($provide, $injector) {
    ...
    if (!$injector.has('sharedDataService')) {
        $provide.value('sharedDataService', null);
    }
