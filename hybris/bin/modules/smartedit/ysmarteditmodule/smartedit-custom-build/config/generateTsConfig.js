...
module.exports = function() {
    ...
    return {
        config: function(data, conf) {
            ...
            const commonsLayerInclude = ["../../jsTarget/web/features/ysmarteditmodulecommons/**/*"];
            const innerLayerInclude = commonsLayerInclude.concat(["../../jsTarget/web/features/ysmarteditmodule/**/*"]);
            const outerLayerInclude = commonsLayerInclude.concat(["../../jsTarget/web/features/ysmarteditmoduleContainer/**/*"]);
            const commonsLayerTestInclude = ["../../jsTests/tests/ysmarteditmodulecommons/unit/**/*"];
            const innerLayerTestInclude = commonsLayerTestInclude.concat(["../../jsTests/tests/ysmarteditmodule/unit/features/**/*"]);
            const outerLayerTestInclude = commonsLayerTestInclude.concat(["../../jsTests/tests/ysmarteditmoduleContainer/unit/features/**/*"]);
