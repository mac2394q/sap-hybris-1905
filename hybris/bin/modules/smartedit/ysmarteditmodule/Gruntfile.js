...
module.exports = (grunt) => {
    ...
    grunt.registerTask('multiKarma', ['karma:ysmarteditmodule', 'karma:ysmarteditmodulecommons', 'karma:ysmarteditmoduleContainer']);
    ...
    grunt.registerTask('test', 'run unit tests', function() {
        ...
        if (target && target.length) {
            target.forEach((t) => {
                if (t === 'inner') {
                    tasks.push('karma:ysmarteditmodule');
                } else if (t === 'outer') {
                    tasks.push('karma:ysmarteditmoduleContainer');
                } else if (t === 'commons') {
                    tasks.push('karma:ysmarteditmodulecommons');
                }
            });
        } else {
            tasks = ['multiKarma'];
