...
@SeModule({
	...
	initialize: (decoratorService: any, featureService: IFeatureService, perspectiveService: IPerspectiveService) => { // Parameters are injected factory methods
		'ngInject';
		////////////////////////////////////////////////////
		// Create Decorator
		////////////////////////////////////////////////////
