...
public class AgentDesktopOrderConversionService
{
	...
	public OrderModel convertOrderModel(final OrderModel orderModel, final int eventType)
	{
		...
		{
			result.setEventType(AgentdesktopdataexchangeConstants.ORDER_CREATED);
		}
		else
		{
			result.setEventType(AgentdesktopdataexchangeConstants.ORDER_UPDATED);
		}


		final String bdType = getConfigurationService().getConfiguration().getString(AgentdesktopdataexchangeConstants.BD_TYPE);
		...
		final String orderId = AgentdesktopdataexchangeConstants.ORDER_ID;
		final String customerAttributeId = getConfigurationService().getConfiguration()
				.getString(AgentdesktopdataexchangeConstants.CUSTOMER_ID_ATTRIBUTE);
