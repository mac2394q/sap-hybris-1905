...
<html>
<head>
    <title>Welcome to agentdesktopdataexchange</title>
    <link rel="stylesheet" href="<c:url value="/static/agentdesktopdataexchange-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "agentdesktopdataexchange" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/agentdesktopdataexchange-items.xml</b> - here you can model your items</li>
            <li><b>resources/agentdesktopdataexchange-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/agentdesktopdataexchange-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/agentdesktopdataexchange-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/agentdesktopdataexchange-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
