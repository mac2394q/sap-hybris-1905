...
public class DefaultEventpublisherb2bService implements Eventpublisherb2bService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultEventpublisherb2bService.class);
	...
	{
		return DefaultEventpublisherb2bService.class.getResourceAsStream("/eventpublisherb2b/sap-hybris-platform.png");
	}
