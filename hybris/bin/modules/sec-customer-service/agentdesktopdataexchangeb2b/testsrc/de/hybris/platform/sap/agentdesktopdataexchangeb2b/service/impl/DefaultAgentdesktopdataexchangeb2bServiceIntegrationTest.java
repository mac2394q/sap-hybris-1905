...
import de.hybris.platform.sap.agentdesktopdataexchangeb2b.service.impl.DefaultAgentdesktopdataexchangeb2bService;
 ...
 */
@IntegrationTest
public class DefaultAgentdesktopdataexchangeb2bServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "agentdesktopdataexchangeb2bPlatformLogo";

		// when
		final String logoUrl = agentdesktopdataexchangeb2bService.getHybrisLogoUrl(logoCode);
