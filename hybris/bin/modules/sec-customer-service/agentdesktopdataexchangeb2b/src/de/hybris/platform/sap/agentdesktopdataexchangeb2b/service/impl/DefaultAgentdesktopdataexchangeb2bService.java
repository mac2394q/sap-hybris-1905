...
public class DefaultAgentdesktopdataexchangeb2bService implements Agentdesktopdataexchangeb2bService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAgentdesktopdataexchangeb2bService.class);
	...
	{
		return DefaultAgentdesktopdataexchangeb2bService.class.getResourceAsStream("/agentdesktopdataexchangeb2b/sap-hybris-platform.png");
	}
