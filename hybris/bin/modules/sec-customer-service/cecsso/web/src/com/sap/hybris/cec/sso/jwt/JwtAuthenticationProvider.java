...
import com.sap.hybris.cec.sso.jwt.util.DefalutJWTUtil;
...
public class JwtAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider
{
	...
	@Override
	protected void additionalAuthenticationChecks(final UserDetails paramUserDetails,
			final UsernamePasswordAuthenticationToken paramUsernamePasswordAuthenticationToken)
	{
	...
	protected UserDetails retrieveUser(final String username, final UsernamePasswordAuthenticationToken authentication)
	{
		...
		return defalutJWTUtil.getUserDetails(token);
