...
public class DefaultAgentdesktopdataexchangecoreService implements AgentdesktopdataexchangecoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAgentdesktopdataexchangecoreService.class);
	...
	{
		return DefaultAgentdesktopdataexchangecoreService.class.getResourceAsStream("/agentdesktopdataexchangecore/sap-hybris-platform.png");
	}
