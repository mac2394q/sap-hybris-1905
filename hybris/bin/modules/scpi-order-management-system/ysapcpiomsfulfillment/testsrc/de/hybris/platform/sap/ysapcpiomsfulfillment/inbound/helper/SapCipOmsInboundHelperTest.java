...
public class SapCipOmsInboundHelperTest {
  ...
  public void setUp() {
    ...
    consignmentModel.setConsignmentEntries(Collections.set(consignmentEntryOne, consignmentEntryTwo));
  ...
  public void processDeliveryNotification() {
    ...
    orderModel.setConsignments(Collections.set(consignmentModel));
