...
public class SapSendConsignmentToExternalFulfillmentSystemStrategyTest {
  ...
  public void setUp() {
    ...
    consignmentOne.setConsignmentEntries(Collections.set(consignmentEntryOne));
    ...
    consignmentTwo.setConsignmentEntries(Collections.set(consignmentEntryOne));
    consignmentTwo.setWarehouse(warehouseModel);
    consignmentTwo.setOrder(orderModel);

    orderModel.setConsignments(Collections.set(consignmentOne, consignmentTwo));
