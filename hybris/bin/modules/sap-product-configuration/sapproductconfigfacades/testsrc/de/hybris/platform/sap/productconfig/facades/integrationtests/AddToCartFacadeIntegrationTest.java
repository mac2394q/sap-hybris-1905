...
public class AddToCartFacadeIntegrationTest extends CPQFacadeLayerTest
{
	...
	{
		CartModificationData modificationData = cartFacade.addToCart(PRODUCT_CODE_YSAP_SIMPLE_POC, 9999L);
		...
		CartModificationData modificationData2 = cartFacade.addToCart(PRODUCT_CODE_YSAP_SIMPLE_POC, 9999L);
