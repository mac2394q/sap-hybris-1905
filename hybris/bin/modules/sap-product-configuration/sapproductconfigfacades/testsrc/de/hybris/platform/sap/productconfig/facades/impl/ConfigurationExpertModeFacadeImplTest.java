...
public class ConfigurationExpertModeFacadeImplTest
{
	...
	public void testDisableExpertModeAllowed()
	{
		...
		verify(sessionService, times(0)).setAttribute(SapproductconfigservicesConstants.EXPERT_MODE_STATE_IN_SESSION, Boolean.FALSE);
	}

	private Set<UserGroupModel> getUserGroups(boolean withExpertModeGroup)
	{
