...
public class UiStatusSyncTest extends AbstractProductConfigControllerBaseTest
{
	...
	public void testUpdateUIStatusFromRequestExpandPromoMessage()
	{
		...
		CsticData cstic = requestData.getGroups().get(0).getCstics().get(0);
	...
	public void testToggleShowExtendedMessageOnUIStatusGroupsEmptyUiStatusGroups(){
		...
		List<UiGroupStatus> uiStatusGroups = null;
	...
	public void testToggleShowExtendedMessageOnStatusCsticsNotFound(){
		...
		List<UiCsticStatus> uiStatusCstics = UiStatusSyncTestHelper.createSimpleUiCsticStatusListWithPromoMessages("cstic_1");
	...
	public void testToggleShowExtendedMessageOnStatusCstics(){
		...
		List<UiCsticStatus> uiStatusCstics = UiStatusSyncTestHelper.createUiCsticStatusListWithPromoMessages();
