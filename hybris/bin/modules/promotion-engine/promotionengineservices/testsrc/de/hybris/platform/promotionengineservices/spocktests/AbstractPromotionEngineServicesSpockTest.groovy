...
class AbstractPromotionEngineServicesSpockTest extends ServicelayerSpockSpecification
{
	...
	def setup()
	{
		importCsv("/impex/promotionengineSampleData.impex", "utf-8")
		importCsv("/impex/promotionengineSampleData-sourceRule.impex", "utf-8")
	}
	...
	public createUser(String userId, String userGroupId)
	{
