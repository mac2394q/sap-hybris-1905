...
public class DefaultRuleEngineCalculationServiceTest extends AbstractRuleEngineTest
{
	...
	public void testSimpleCalculateTotals()
	{
		...
		assertEquals(new BigDecimal("100.03"), simple02.getTotalIncludingCharges()); // NOSONAR
	...
	public void testChangeDeliveryMode()
	{
		...
		assertEquals(new BigDecimal("100.03"), simple03.getTotalIncludingCharges());
		...
		getRuleEngineCalculationService().calculateTotals(simple03);
		assertEquals(new BigDecimal("105.03"), simple03.getTotalIncludingCharges());
		assertEquals(new BigDecimal("95.03"), simple03.getTotal());
		assertEquals(new BigDecimal("95.03"), simple03.getSubTotal());
		...
		assertEquals(new BigDecimal("120.03"), simple03.getTotalIncludingCharges());
		assertEquals(new BigDecimal("95.03"), simple03.getTotal());
		assertEquals(new BigDecimal("95.03"), simple03.getSubTotal());
	...
	public void testAddOrderLevelDiscountPercentage()
	{
		...
		assertEquals(new BigDecimal("90.53"), simple03.getTotalIncludingCharges());
	}
	...
	public void testAddOrderLevelDiscountAbsolute()
	{
		...
		assertEquals(new BigDecimal("90.03"), simple03.getTotalIncludingCharges());
	}
	...
	public void testAddOrderEntryLevelDiscountPercentage()
	{
		...
		assertEquals(new BigDecimal("100.03"), simple04.getTotalIncludingCharges());
		...
		assertEquals(new BigDecimal("97.57"), simple04.getTotalIncludingCharges());
	}
	...
	public void testAddOrderEntryLevelDoubleDiscountPercentage()
	{
		...
		assertEquals(new BigDecimal("36.02"), simple06.getTotalIncludingCharges());
		assertEquals(new BigDecimal("31.02"), simple06.getTotal());
		...
		getRuleEngineCalculationService().addOrderEntryLevelDiscount(orderEntry1, false, new BigDecimal("25.00"));
		...
		assertEquals(new BigDecimal("20.95"), simple06.getTotal());
		assertEquals(new BigDecimal("25.95"), simple06.getTotalIncludingCharges());
	}
	...
	public void testAddOrderEntryLevelDoubleDiscountPercentage2()
	{
		...
		assertEquals(new BigDecimal("36.02"), simple07.getTotalIncludingCharges());
		assertEquals(new BigDecimal("31.02"), simple07.getTotal());
		...
		assertEquals(new BigDecimal("5.00"), simple07.getDeliveryCost());
		assertEquals(new BigDecimal("20.94"), simple07.getTotal());
		assertEquals(new BigDecimal("20.94"), simple07.getSubTotal());
		assertEquals(new BigDecimal("25.94"), simple07.getTotalIncludingCharges());
	}
	...
	public void testAddOrderEntryLevelDiscountAbsolute()
	{
		...
		assertEquals(new BigDecimal("100.03"), simple05.getTotalIncludingCharges());
		...
		assertEquals(new BigDecimal("80.03"), simple05.getTotalIncludingCharges());
	}
	...
	public void testAddOrderEntryLevelFixedPrice()
	{
		...
		assertEquals(new BigDecimal("58.00"), cartRao1.getTotalIncludingCharges()); // NOSONAR
		...
		assertEquals(new BigDecimal("55.50"), cartRao1.getTotalIncludingCharges());
	...
	public void testAddOrderEntryLevelFixedPriceError()
	{
		...
		getRuleEngineCalculationService().calculateTotals(cartRao1);
		assertEquals(new BigDecimal("58.00"), cartRao1.getTotalIncludingCharges());
	...
	public void testExcludedProducts()
	{
		...
		getRuleEngineCalculationService().calculateTotals(cartRao1);
		assertEquals(new BigDecimal("41.50"), cartRao1.getTotalIncludingCharges());
