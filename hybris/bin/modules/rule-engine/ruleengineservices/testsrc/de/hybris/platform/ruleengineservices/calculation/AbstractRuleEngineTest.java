...
public abstract class AbstractRuleEngineTest
{
	...
	public void setUpAbstractRuleEngineTest()
	{
		...
		when(commonI18NService.getCurrency(USD)).thenReturn(currencyUSD);
		when(commonI18NService.getCurrency(EUR)).thenReturn(currencyEUR);
		...
		final AbstractPopulatingConverter<ProductModel, ProductRAO> productRaoConverter = new AbstractPopulatingConverter<>();
