...
public class DefaultDroolsRuleConditionsGeneratorTest extends AbstractGeneratorTest
{
	...
	public void testSingleCondition() throws IOException
	{
		...
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, amountCondition)).thenReturn(
	...
	public void testSingleConditionWithExcludedVariableClassNames() throws IOException
	{
		...
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, amountCondition))
	...
	public void testSingleRelConditionWithTargetAttribute() throws IOException
	{
		...
		final RuleIrAttributeCondition qtyCondition = createRuleIrAttributeCondition("quantity",
		...
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, qtyCondition)).thenReturn("new Integer(1)");
	...
	public void testMultipleConditions() throws IOException
	{
		...
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, colorCondition)).thenReturn("\"blue\"");
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, amountCondition)).thenReturn(
				"new java.math.BigDecimal(\"100\")");
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, code))
		.thenReturn("code == \"123\" || code == \"456\" || code == \"789\"");
	...
	protected List<RuleIrCondition> createPatternConditions()
	{
		...
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, attributeCondition))
	...
	private List<RuleIrCondition> createGroupConditions()
	{
		...
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, attributeCondition111))
				.thenReturn("code == \"1234567\"");
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, attributeCondition211)).thenReturn("code == \"902\"");
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, attributeCondition113)).thenReturn("new Integer(1)");
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, attributeCondition213)).thenReturn("new Integer(1)");
	...
	private List<RuleIrCondition> createGroupNotConditions()
	{
		...
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, attributeCondition111))
				.thenReturn("\"USD\"");
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, attributeCondition112))
				.thenReturn("new BigDecimal(\"100\")");
		when(droolsRuleValueFormatter.formatValue(droolsRuleGeneratorContext, attributeCondition121))
