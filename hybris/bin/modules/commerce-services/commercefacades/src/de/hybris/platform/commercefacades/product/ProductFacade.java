...
public interface ProductFacade
{
	 ...
	 * @deprecated Since 6.0. Use {@link ProductFacade#getProductForCodeAndOptions(String, Collection)} instead.
	 */
	...
	/**
	 * Gets the first X reviews for specified product. Current session catalog version is used to retrieve reviews from
	 * proper product.
	 *
	 * @param productCode
	 *           the product code
	 * @param numberOfReviews
	 *           the number of reviews to show, if null shows all reviews, if exceeds the total number of reviews, shows
	 ...
	 */
	List<ReviewData> getReviews(String productCode, Integer numberOfReviews) throws UnknownIdentifierException,
			IllegalArgumentException;

	/**
	 * Retrieves product references of a product given its code.
	 *
	 * @deprecated Since 5.0. Use {{@link #getProductReferencesForCode(String, List, List, Integer)} instead.
	 * @param code
	 *           the product code
	 * @param referenceType
	 ...
	 */
	@Nonnull
	List<ConfigurationInfoData> getConfiguratorSettingsForCode(@Nonnull String code);
}
