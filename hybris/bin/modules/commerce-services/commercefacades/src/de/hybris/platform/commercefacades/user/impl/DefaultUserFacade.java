...
public class DefaultUserFacade implements UserFacade
{
	...
	public void addAddress(final AddressData addressData)
	{
		...
		final boolean makeThisAddressTheDefault =
				addressData.isDefaultAddress() || (currentCustomer.getDefaultShipmentAddress() == null && addressData
		...
		if (currentCustomer.getDefaultPaymentInfo() == null)
		{
			...
			if (CollectionUtils.isNotEmpty(ccPaymentInfoModelList))
			{
				getCustomerAccountService()
						.setDefaultPaymentInfo(currentCustomer, ccPaymentInfoModelList.get(ccPaymentInfoModelList.size() - 1));
			}
		}
	}
