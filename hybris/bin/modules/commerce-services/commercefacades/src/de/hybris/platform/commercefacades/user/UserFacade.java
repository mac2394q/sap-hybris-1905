...
public interface UserFacade
{
	 ...
	 * The given <code>id</code> is used to find the user in matching strategies that use one of the unique identifiers to recognize the user.
	 *
	 * @param id
	...
	/**
	 * Returns the UID of the found user.
	 * The user is searched by a matching strategy that uses one of the unique identifiers to recognize the user.
	 *
	 * @param id
