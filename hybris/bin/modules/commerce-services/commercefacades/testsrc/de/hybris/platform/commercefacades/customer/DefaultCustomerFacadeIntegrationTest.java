...
public class DefaultCustomerFacadeIntegrationTest extends ServicelayerTest
{
	...
	public void setUp() throws Exception
	{
		...
		ENCODING = configurationService.getConfiguration().getString("default.password.encoding",
				PasswordEncoderConstants.DEFAULT_ENCODING);
		customerAccountService.setPasswordEncoding(ENCODING);
	}
	...
	public void testUpdatePassword() throws TokenInvalidatedException
	{
		...
		modelService.refresh(customerModel);
		Assert.assertNull(customerModel.getToken());
		final String expected = passwordEncoderService.encode(customerModel, NEW_PASSWORD, ENCODING);
	...
	public void testRegisterCheckCustomerType() throws DuplicateUidException
	{
		...
		Assert.assertEquals(CustomerType.REGISTERED.getCode(), customerModel.getType().getCode());
	}
	...
	public void testRegisterAndChangePassword() throws DuplicateUidException
	{
		...
		Assert.assertEquals(ENCODING, userModel.getPasswordEncoding());
		...
		Assert.assertEquals(ENCODING, userModel2.getPasswordEncoding());
	...
	public void testForgottenPassword() throws IOException
	{
		...
		customer.setUid(
				"Testtesttesttesttesttesttest.testtesttesttest.testtesttesttest.testtest.test.test.test.test.test.ttesttesttesttesttesttesttestset@example.com");
