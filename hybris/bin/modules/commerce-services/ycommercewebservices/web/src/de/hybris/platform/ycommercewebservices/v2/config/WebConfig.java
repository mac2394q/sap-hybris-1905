...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "ycommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "ycommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "ycommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "ycommercewebservices.v2.description";
	private static final String TITLE = "ycommercewebservices.v2.title";
	private static final String VERSION = "ycommercewebservices.v2.version";
	private static final String LICENSE = "ycommercewebservices.v2.license";
	private static final String LICENSE_URL = "ycommercewebservices.v2.license.url";
