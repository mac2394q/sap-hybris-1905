...
public class DefaultDeliveryService implements DeliveryService
{
	...
	{
		final Collection<CountryModel> countries = getCommerceCommonI18NService().getAllCountries();
	...
	{
		return getDeliveryAddressesLookupStrategy().getDeliveryAddressesForOrder(abstractOrder, visibleAddressesOnly);
	}
