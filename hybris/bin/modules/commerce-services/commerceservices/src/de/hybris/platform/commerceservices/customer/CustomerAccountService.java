...
public interface CustomerAccountService
{
	 ...
	 *            the illegal argument exception is thrown when given payment info does not belong to the given customer
	 *            or any argument is null
	 * @deprecated Since 6.7. Use {@link CustomerAccountService#deleteCCPaymentInfo(CustomerModel, CreditCardPaymentInfoModel)}
	 */
	 ...
	 */
	SearchPageData<ReturnRequestModel> getReturnRequestsByCustomerAndStore(CustomerModel customerModel, BaseStoreModel store,
	 ...
	 *
	 * @param user
	 *           customer whose account is to be closed
