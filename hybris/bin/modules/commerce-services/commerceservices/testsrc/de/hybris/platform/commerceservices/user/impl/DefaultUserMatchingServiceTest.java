...
public class DefaultUserMatchingServiceTest
{
	...
	public void setUp()
	{
		...
		given(customerIdMatchingStrategy.getUserByProperty(TEST1_CUSTOMER_ID, CustomerModel.class))
		...
		final List<UserPropertyMatchingStrategy> matchingStrategies = Lists.<UserPropertyMatchingStrategy>newArrayList(
				customerIdMatchingStrategy, userMatchingStrategy);
