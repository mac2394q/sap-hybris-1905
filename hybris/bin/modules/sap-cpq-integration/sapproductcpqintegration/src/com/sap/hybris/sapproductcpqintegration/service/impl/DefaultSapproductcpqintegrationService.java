...
public class DefaultSapproductcpqintegrationService implements SapproductcpqintegrationService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapproductcpqintegrationService.class);
	...
	{
		return DefaultSapproductcpqintegrationService.class.getResourceAsStream("/sapproductcpqintegration/sap-hybris-platform.png");
	}
