 ...
 */
package com.sap.hybris.sapquoteintegrationoms.controller;
...
@Controller
public class SapquoteintegrationomsHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", sapquoteintegrationomsService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
