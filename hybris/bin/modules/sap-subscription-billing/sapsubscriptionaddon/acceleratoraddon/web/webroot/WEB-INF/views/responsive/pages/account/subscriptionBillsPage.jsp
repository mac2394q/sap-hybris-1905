...
<form:form id="billsForm" name="subscriptionBillForm" modelAttribute="subscriptionBillForm" action="${fn:escapeXml(viewSubscriptionBillsUrl)}" method="post" autocomplete="off">
