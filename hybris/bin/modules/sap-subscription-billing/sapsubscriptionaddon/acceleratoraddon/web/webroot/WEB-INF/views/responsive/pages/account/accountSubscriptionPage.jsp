...
<c:if test="${subscriptionData.status eq 'ACTIVE' && not empty subscriptionData.validTillDate}">
						...
						<form:form id="subscriptionExtensionForm" name="subscriptionExtensionForm" modelAttribute="subscriptionExtensionForm" action="${fn:escapeXml(extendSubscriptionUrl)}" method="post">
