...
<%@ taglib prefix="multi-checkout-addon"
	tagdir="/WEB-INF/tags/addons/sapsubscriptionaddon/responsive/checkout/multi"%>
...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<div class="row">
		<div class="col-sm-6">
			...
			<multiCheckout:checkoutSteps checkoutSteps="${checkoutSteps}"
				...
				<jsp:body>
                    <div class="checkout-paymentmethod">
                        <div class="checkout-indent">
                            <div class="headline">
							    ...
							    <form:form id="js-new-card-register-form"
									name="newCardRegisterCard"
									action="${request.contextPath}/checkout/multi/sap-digital-payment/cards/new-card"
									method="GET">
								...
								<button type="button"
									class="btn btn-primary btn-block js-checkout-payment-add-newcard">
									<spring:theme code="checkout.multi.paymentMethod.add.newcard" />
								</button>
								
							
								<form:form id="billingAddressDetailsForm"
									name="billingAddressDetailsForm"
									modelAttribute="billingAddressDetailsForm"
									action="${request.contextPath}/checkout/multi/sap-digital-payment/billing-address/add"
									method="POST">
                                    <hr />
                                    <div class="headline">
                                        <spring:theme
                    ...
                    <button type="button"
						class="btn btn-primary btn-block submit_billingAddressDetailsPostForm checkout-next">
		...
		<div class="col-sm-6 hidden-xs">
				<multi-checkout-addon:checkoutOrderDetails cartData="${cartData}"
