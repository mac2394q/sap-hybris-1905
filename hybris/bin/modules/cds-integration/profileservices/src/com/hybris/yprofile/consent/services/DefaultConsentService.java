...
public class DefaultConsentService implements ConsentService {
    ...
    public boolean isProfileTrackingConsentGiven(final HttpServletRequest request){
        if (isAnonymousUser()) {
            return isProfileTrackingConsentGivenForAnonymousUserForRequest(request);
        } else {
    ...
    protected boolean isProfileTrackingConsentGivenForAnonymousUserForRequest(final HttpServletRequest request) {
