...
public class DefaultCartFacade extends de.hybris.platform.commercefacades.order.impl.DefaultCartFacade implements B2BCartFacade
{
	...
	protected <T extends AbstractOrderData> OrderEntryData groupOrderEntry(final T orderData, final ProductData productData,
	...
	protected PriceData createPrice(final PriceData currentEntryPrice, final PriceData orderEntryPrice)
	{
	...
	@Override
	public List<CartModificationData> addOrderEntryList(final List<OrderEntryData> cartEntries) throws EntityValidationException
	{
		throw new UnsupportedOperationException();
	}
