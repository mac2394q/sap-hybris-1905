...
public class ProductStockThresholdPopulatorTest
{
	...
	private void mockSomeStuff()
	{
		...
		when(commerceStockService.getStockLevelForProductAndBaseStore(variant, baseStore)).thenReturn(Long.valueOf(1000));
		when(commerceStockService.getStockLevelStatusForProductAndBaseStore(variant, baseStore))
