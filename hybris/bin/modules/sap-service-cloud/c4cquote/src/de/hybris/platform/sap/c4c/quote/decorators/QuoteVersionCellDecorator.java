...
/**
 * Decorator class for maintaining the versions of quote
 */
public class QuoteVersionCellDecorator implements CSVCellDecorator
{
	...
	public String decorate(int position, Map<Integer, String> impexLine)
	{
		...
		if (quote != null)
		{
			return Integer.toString(getInboundQuoteVersionControlHelper().getUpdatedVersionNumber(quote));
		}
		else
		{
