...
/**
 * JUnit for @QuoteVersionCellDecorator
 */
@UnitTest
public class QuoteVersionCellDecoratorTest {
	...
	@InjectMocks
	private final QuoteVersionCellDecorator decorator = new QuoteVersionCellDecorator();
	...
	public void decorateTest() {
		...
		when(inboundQuoteVersionControlHelper.getUpdatedVersionNumber(quoteModel)).thenReturn(VERSION_OUTPUT);
	...
	public void newQuoteTest() {
		...
		String resultVersion = decorator.decorate(VERSION_POSITION_INT, srcLine);
		Assert.assertEquals(Integer.toString(1), resultVersion);
	}
}
