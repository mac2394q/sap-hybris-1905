...
public class AlternativeProductImpl implements AlternativeProduct
{
	...
	/**
	 * Performs a deep copy of this object. Because of the fact that all fields of this object consist of immutable
	 * objects like <code>String</code> and <code>TechKey</code> or primitive types the shallow copy is identical with a
	 * deep copy.
	 *
