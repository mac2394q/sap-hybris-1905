...
/**
 * Deprecated since 6.0, use {@link NeedsEmbeddedServer} annotation to run embedded server on test class and
...
public abstract class AbstractWebServicesTest extends ServicelayerTest
{
	...
	/**
	 * Method creates client which accepts all hostname and trust all certificates - because of that it is suitable only for
	 * tests
	 *
	 * @param config
	 *           client config
