...
public class EmbeddedServerController implements InitializingBean
{
	...
	/**
	 * Function modifies the EhCache cache suffix. This is required in order to run embedded server by running platform (the
	 * same web application is deployed twice). It may cause side effects in host platform.
	 *
	 */
	...
	{
		final List<String> notStarted = Arrays.stream(webExtentionNames)//
