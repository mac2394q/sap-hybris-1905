...
class EntityPropertyProcessorUnitTest extends Specification {
    ...
    def "converted entity is empty when item #condition"() {
        ...
        descriptor(collection: true, primitive: false) | 'property is collection'
        descriptor(collection: false, primitive: true) | 'property is primitive'
        descriptor(collection: true, primitive: true)  | 'property is primitive collection'
    ...
    private TypeAttributeDescriptor applicableDescriptor() {
        descriptor(collection: false, primitive: false)
    }
