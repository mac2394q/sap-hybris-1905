...
class EntityCollectionPropertyProcessorUnitTest extends Specification {
    ...
    def integrationObjectService = Stub(IntegrationObjectService) {
        findIntegrationObjectItemByTypeCode(INTEGRATION_OBJECT_CODE, ITEM_TYPE) >> IO_ITEM
    }
    ...
    def propertyProcessor = new EntityCollectionPropertyProcessor(
    ...
    private TypeAttributeDescriptor applicableDescriptor() {
        descriptor(collection: true, primitive: false)
    }
