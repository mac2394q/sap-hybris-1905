...
export class PersonalizationsmarteditManagerViewUtilsService {
				...
				.then((responseCustomization: any) => {
					...
					this.personalizationsmarteditRestService.updateCustomization(responseCustomization)
						.then(() => {
							...
							this.personalizationsmarteditMessageHandler.sendError(this.$filter('translate')('personalization.error.deletingcustomization'));
						});
				}, () => {
					this.personalizationsmarteditMessageHandler.sendError(this.$filter('translate')('personalization.error.deletingcustomization'));
				});
				...
				.then((responseVariation: any) => {
					...
					this.personalizationsmarteditRestService.editVariation(customization.code, responseVariation)
						.then((response: any) => {
							...
							this.personalizationsmarteditMessageHandler.sendError(this.$filter('translate')('personalization.error.deletingvariation'));
						});
				}, () => {
					this.personalizationsmarteditMessageHandler.sendError(this.$filter('translate')('personalization.error.deletingvariation'));
				});
			...
			.then((responseVariation: any) => {
				...
				this.personalizationsmarteditRestService.editVariation(customization.code, responseVariation)
					.then((response: any) => {
						...
						this.personalizationsmarteditMessageHandler.sendError(this.$filter('translate')('personalization.error.editingvariation'));
					});
			}, () => {
				this.personalizationsmarteditMessageHandler.sendError(this.$filter('translate')('personalization.error.gettingvariation'));
			});
	}
	...
	public customizationClickAction = (customization: any) => {
		return this.personalizationsmarteditRestService.getVariationsForCustomization(customization.code, customization).then(
			...
			() => {
				this.personalizationsmarteditMessageHandler.sendError(this.$filter('translate')('personalization.error.gettingcustomization'));
			});
	}
