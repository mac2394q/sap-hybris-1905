...
@IntegrationTest
public class AsCategoryAwareSearchProfileSynchronizationTest extends AbstractAsSynchronizationTest
{
	...
	public void synchronizeNewSearchProfile() throws Exception
	{
		...
		final AsCategoryAwareSearchProfileModel synchronizedSearchProfile = searchProfileOptional.get();
