...
public class AsExcludedFacetValueSynchronizationTest extends AbstractAsSynchronizationTest
{
	...
	@Test
	public void excludedFacetValueNotFoundBeforeSynchronization() throws Exception
	{
		// given
		...
		final Optional<AsExcludedFacetValueModel> synchronizedPromotedValueOptional = asConfigurationService
	...
	@Test
	public void synchronizeNewExcludedFacetValue() throws Exception
	{
		// given
		final AsExcludedFacetValueModel excludedValue = asConfigurationService.createConfiguration(AsExcludedFacetValueModel.class);
		excludedValue.setCatalogVersion(stagedCatalogVersion);
		...
		final AsExcludedFacetValueModel synchronizedPromotedValue = synchronizedPromotedValueOptional.get();
		assertSynchronized(excludedValue, synchronizedPromotedValue, AbstractAsSortConfigurationModel.UNIQUEIDX);
	}

	@Test
	public void synchronizeUpdatedExcludedFacetValue() throws Exception
	{
		// given
		final AsExcludedFacetValueModel excludedValue = asConfigurationService.createConfiguration(AsExcludedFacetValueModel.class);
		excludedValue.setCatalogVersion(stagedCatalogVersion);
	...
	@Test
	public void synchronizeRemovedExcludedFacetValue() throws Exception
	{
		// given
		final AsExcludedFacetValueModel excludedValue = asConfigurationService.createConfiguration(AsExcludedFacetValueModel.class);
		excludedValue.setCatalogVersion(stagedCatalogVersion);
